...
/// <summary>
///    VK_KHR_xlib_surface - instance extension (nr. 5) - author 'KHR' [platform 'xlib' | contact 'Jesse Hall @critsec,Ian Elliott @ianelliottus']<br/>
...
public static unsafe partial class VkKhrXlibSurface
{
    ...
    /// <summary> vkCreateXlibSurfaceKHR - Create a slink:VkSurfaceKHR object for an X11 window, using the Xlib client-side library - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateXlibSurfaceKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateXlibSurfaceKHR.html</a> </summary>
    ...
    /// <summary> vkGetPhysicalDeviceXlibPresentationSupportKHR - Query physical device for presentation to X11 server using Xlib - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceXlibPresentationSupportKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceXlibPresentationSupportKHR.html</a> </summary>
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkCreateXlibSurfaceKHR = (delegate*<VkInstance, VkXlibSurfaceCreateInfoKHR*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u7243\u6165\u6574\u6c58\u6269\u7553\u6672\u6361\u4b65\u5248\u0000");
        }
        ...
        {
            *pvkGetPhysicalDeviceXlibPresentationSupportKHR = (delegate*<VkPhysicalDevice, uint, Display*, VisualID, VkBool32>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u6547\u5074\u7968\u6973\u6163\u446c\u7665\u6369\u5865\u696c\u5062\u6572\u6573\u746e\u7461\u6f69\u536e\u7075\u6f70\u7472\u484b\u0052");
        }
    }
}
