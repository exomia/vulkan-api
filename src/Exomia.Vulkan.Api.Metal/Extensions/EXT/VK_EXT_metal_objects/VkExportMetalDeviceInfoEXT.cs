...
public unsafe struct VkExportMetalDeviceInfoEXT
{
    ...
    /// <summary> mtlDevice is the Metal id&lt;MTLDevice&gt; object underlying the VkPhysicalDevice associated with the VkDevice object identified in the call. The implementation will return the MTLDevice in this member, or it will return NULL if no MTLDevice could be found underlying the VkPhysicalDevice object. </summary>
