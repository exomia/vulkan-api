...
/// <summary>
///     VkExportMetalCommandQueueInfoEXT - Structure that identifies a VkQueue object and corresponding Metal
...
public unsafe struct VkExportMetalCommandQueueInfoEXT
{
    ...
    /// <summary>
    ///     mtlCommandQueue is the Metal id&lt;MTLCommandQueue&gt; object underlying the VkQueue object in queue. The
    ///     implementation will return the MTLCommandQueue in this member, or it will return NULL if no MTLCommandQueue could
    ///     be found underlying the VkQueue object.
    /// </summary>
