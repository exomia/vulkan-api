...
/// <summary>
///    VK_EXT_metal_surface - instance extension (nr. 218) - author 'EXT' [platform 'metal' | contact 'Dzmitry Malyshau @kvark']<br/>
...
public static unsafe partial class VkExtMetalSurface
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_METAL_SURFACE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
    ...
    /// <summary> vkCreateMetalSurfaceEXT - Create a VkSurfaceKHR object for CAMetalLayer - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateMetalSurfaceEXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateMetalSurfaceEXT.html</a> </summary>
    /// <param name="instance">instance is the instance with which to associate the surface.</param>
    /// <param name="pCreateInfo">pCreateInfo is a pointer to a VkMetalSurfaceCreateInfoEXTstructure specifying parameters affecting the creation of the surface object.</param>
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkCreateMetalSurfaceEXT = (delegate*<VkInstance, VkMetalSurfaceCreateInfoEXT*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u7243\u6165\u6574\u654d\u6174\u536c\u7275\u6166\u6563\u5845\u0054");
        }
    }
}
