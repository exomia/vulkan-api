...
/// <summary>
///    VK_GGP_frame_token - device extension (nr. 192) - author 'GGP' [platform 'ggp' | contact 'Jean-Francois Roy @jfroy']<br/>
...
public static unsafe partial class VkGgpFrameToken
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_GGP_FRAME_TOKEN_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
