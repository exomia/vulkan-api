...
/// <summary>
///    VK_FUCHSIA_external_memory - device extension (nr. 365) - author 'FUCHSIA' [platform 'fuchsia' | contact 'John Rosasco @rosasco']<br/>
...
public static unsafe partial class VkFuchsiaExternalMemory
{
    ...
    ///     }
    /// </remarks>
    public const string VK_FUCHSIA_EXTERNAL_MEMORY_EXTENSION_NAME_UTF8_NT = "\u4b56\u465f\u4355\u5348\u4149\u455f\u5458\u5245\u414e\u5f4c\u454d\u4f4d\u5952\u455f\u5458\u4e45\u4953\u4e4f\u4e5f\u4d41\u0045";

    /// <summary> vkGetMemoryZirconHandleFUCHSIA - Get a Zircon handle for an external memory object - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryZirconHandleFUCHSIA.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryZirconHandleFUCHSIA.html</a> </summary>
    ...
    /// <summary> vkGetMemoryZirconHandlePropertiesFUCHSIA - Get a Zircon handle properties for an external memory object - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryZirconHandlePropertiesFUCHSIA.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryZirconHandlePropertiesFUCHSIA.html</a> </summary>
    /// <param name="device">device is the VkDevice.</param>
    ...
    /// <remarks><list type="table">
    ///     <item><term>successcodes</term><description>VK_SUCCESS</description></item>
    ///     <item><term>errorcodes</term><description>VK_ERROR_INVALID_EXTERNAL_HANDLE</description></item>
    /// </list></remarks>
    public static readonly delegate*<
        VkDevice /*device*/, 
    ...
    public static void Load(VkDevice device) {
        ...
        {
            *pvkGetMemoryZirconHandleFUCHSIA = (delegate*<VkDevice, VkMemoryGetZirconHandleInfoFUCHSIA*, zx_handle_t*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4d74\u6d65\u726f\u5a79\u7269\u6f63\u486e\u6e61\u6c64\u4665\u4355\u5348\u4149\u0000");
        }
        fixed(delegate*<VkDevice, VkExternalMemoryHandleTypeFlagBits, zx_handle_t, VkMemoryZirconHandlePropertiesFUCHSIA*, VkResult>* pvkGetMemoryZirconHandlePropertiesFUCHSIA = &vkGetMemoryZirconHandlePropertiesFUCHSIA) 
        {
            *pvkGetMemoryZirconHandlePropertiesFUCHSIA = (delegate*<VkDevice, VkExternalMemoryHandleTypeFlagBits, zx_handle_t, VkMemoryZirconHandlePropertiesFUCHSIA*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4d74\u6d65\u726f\u5a79\u7269\u6f63\u486e\u6e61\u6c64\u5065\u6f72\u6570\u7472\u6569\u4673\u4355\u5348\u4149\u0000");
        }
    }
}
