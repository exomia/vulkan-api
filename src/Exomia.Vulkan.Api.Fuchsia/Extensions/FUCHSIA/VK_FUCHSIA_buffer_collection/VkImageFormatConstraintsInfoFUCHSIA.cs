...
/// <summary> VkImageFormatConstraintsInfoFUCHSIA - Structure image-based buffer collection constraints - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkImageFormatConstraintsInfoFUCHSIA.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkImageFormatConstraintsInfoFUCHSIA.html</a></summary>
...
public unsafe struct VkImageFormatConstraintsInfoFUCHSIA {
    ...
    public void* pNext;
    /// <summary>imageCreateInfo is the VkImageCreateInfo used to create a VkImage that is to use memory from the VkBufferCollectionFUCHSIA</summary>
    public VkImageCreateInfo imageCreateInfo;
    /// <summary>requiredFormatFeatures is a bitmask of VkFormatFeatureFlagBits specifying required features of the buffers in the buffer collection</summary>
