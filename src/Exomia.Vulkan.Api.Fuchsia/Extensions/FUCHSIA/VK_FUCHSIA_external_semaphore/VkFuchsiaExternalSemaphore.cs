...
/// <summary>
///    VK_FUCHSIA_external_semaphore - device extension (nr. 366) - author 'FUCHSIA' [platform 'fuchsia' | contact 'John Rosasco @rosasco']<br/>
...
public static unsafe partial class VkFuchsiaExternalSemaphore
{
    ...
    ///     }
    /// </remarks>
    public const string VK_FUCHSIA_EXTERNAL_SEMAPHORE_EXTENSION_NAME_UTF8_NT = "\u4b56\u465f\u4355\u5348\u4149\u455f\u5458\u5245\u414e\u5f4c\u4553\u414d\u4850\u524f\u5f45\u5845\u4554\u534e\u4f49\u5f4e\u414e\u454d\u0000";

    /// <summary> vkImportSemaphoreZirconHandleFUCHSIA - Import a semaphore from a Zircon event handle - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkImportSemaphoreZirconHandleFUCHSIA.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkImportSemaphoreZirconHandleFUCHSIA.html</a> </summary>
    ...
    /// <summary> vkGetSemaphoreZirconHandleFUCHSIA - Get a Zircon event handle for a semaphore - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetSemaphoreZirconHandleFUCHSIA.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetSemaphoreZirconHandleFUCHSIA.html</a> </summary>
    ...
    public static void Load(VkDevice device) {
        ...
        {
            *pvkImportSemaphoreZirconHandleFUCHSIA = (delegate*<VkDevice, VkImportSemaphoreZirconHandleInfoFUCHSIA*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6d49\u6f70\u7472\u6553\u616d\u6870\u726f\u5a65\u7269\u6f63\u486e\u6e61\u6c64\u4665\u4355\u5348\u4149\u0000");
        }
        ...
        {
            *pvkGetSemaphoreZirconHandleFUCHSIA = (delegate*<VkDevice, VkSemaphoreGetZirconHandleInfoFUCHSIA*, zx_handle_t*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u5374\u6d65\u7061\u6f68\u6572\u695a\u6372\u6e6f\u6148\u646e\u656c\u5546\u4843\u4953\u0041");
        }
    }
}
