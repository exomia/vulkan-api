...
public static unsafe class VkFuchsiaExternalSemaphore
{
    ...
    public static void Load(VkDevice device)
    {
        ...
        {
            *pvkImportSemaphoreZirconHandleFUCHSIA = (delegate*<VkDevice, VkImportSemaphoreZirconHandleInfoFUCHSIA*, VkResult>)GetVkFunction(
        ...
        {
            *pvkGetSemaphoreZirconHandleFUCHSIA = (delegate*<VkDevice, VkSemaphoreGetZirconHandleInfoFUCHSIA*, zx_handle_t*, VkResult>)GetVkFunction(
