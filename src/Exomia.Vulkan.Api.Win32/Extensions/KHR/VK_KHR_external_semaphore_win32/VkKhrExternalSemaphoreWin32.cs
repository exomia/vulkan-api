...
/// <summary>
///    VK_KHR_external_semaphore_win32 - device extension (nr. 79) - author 'KHR' [platform 'win32' | contact 'James Jones @cubanismo']<br/>
///    <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VK_KHR_external_semaphore_win32.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VK_KHR_external_semaphore_win32.html</a>
/// </summary>
[VkRequires("VK_KHR_external_semaphore")]
public static unsafe partial class VkKhrExternalSemaphoreWin32
{
    ...
    ///     }
    /// </remarks>
    public const string VK_KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME_UTF8_NT = "\u4b56\u4b5f\u5248\u455f\u5458\u5245\u414e\u5f4c\u4553\u414d\u4850\u524f\u5f45\u4957\u334e\u5f32\u5845\u4554\u534e\u4f49\u5f4e\u414e\u454d\u0000";

    /// <summary> vkImportSemaphoreWin32HandleKHR - Import a semaphore from a Windows HANDLE - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkImportSemaphoreWin32HandleKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkImportSemaphoreWin32HandleKHR.html</a> </summary>
    ...
    /// <summary> vkGetSemaphoreWin32HandleKHR - Get a Windows HANDLE for a semaphore - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetSemaphoreWin32HandleKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetSemaphoreWin32HandleKHR.html</a> </summary>
    ...
    public static void Load(VkDevice device) {
        ...
        {
            *pvkImportSemaphoreWin32HandleKHR = (delegate*<VkDevice, VkImportSemaphoreWin32HandleInfoKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6d49\u6f70\u7472\u6553\u616d\u6870\u726f\u5765\u6e69\u3233\u6148\u646e\u656c\u484b\u0052");
        }
        ...
        {
            *pvkGetSemaphoreWin32HandleKHR = (delegate*<VkDevice, VkSemaphoreGetWin32HandleInfoKHR*, HANDLE*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u5374\u6d65\u7061\u6f68\u6572\u6957\u336e\u4832\u6e61\u6c64\u4b65\u5248\u0000");
        }
    }
}
