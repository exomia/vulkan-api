...
/// <summary>
///    VK_KHR_external_memory_win32 - device extension (nr. 74) - author 'KHR' [platform 'win32' | contact 'James Jones @cubanismo']<br/>
...
public static unsafe partial class VkKhrExternalMemoryWin32
{
    ...
    ///     }
    /// </remarks>
    public const string VK_KHR_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME_UTF8_NT = "\u4b56\u4b5f\u5248\u455f\u5458\u5245\u414e\u5f4c\u454d\u4f4d\u5952\u575f\u4e49\u3233\u455f\u5458\u4e45\u4953\u4e4f\u4e5f\u4d41\u0045";

    /// <summary> vkGetMemoryWin32HandleKHR - Get a Windows HANDLE for a memory object - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryWin32HandleKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryWin32HandleKHR.html</a> </summary>
    ...
    /// <summary> vkGetMemoryWin32HandlePropertiesKHR - Get Properties of External Memory Win32 Handles - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryWin32HandlePropertiesKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryWin32HandlePropertiesKHR.html</a> </summary>
    ...
    public static void Load(VkDevice device) {
        ...
        {
            *pvkGetMemoryWin32HandleKHR = (delegate*<VkDevice, VkMemoryGetWin32HandleInfoKHR*, HANDLE*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4d74\u6d65\u726f\u5779\u6e69\u3233\u6148\u646e\u656c\u484b\u0052");
        }
        fixed(delegate*<VkDevice, VkExternalMemoryHandleTypeFlagBits, HANDLE, VkMemoryWin32HandlePropertiesKHR*, VkResult>* pvkGetMemoryWin32HandlePropertiesKHR = &vkGetMemoryWin32HandlePropertiesKHR) 
        {
            *pvkGetMemoryWin32HandlePropertiesKHR = (delegate*<VkDevice, VkExternalMemoryHandleTypeFlagBits, HANDLE, VkMemoryWin32HandlePropertiesKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4d74\u6d65\u726f\u5779\u6e69\u3233\u6148\u646e\u656c\u7250\u706f\u7265\u6974\u7365\u484b\u0052");
        }
    }
}
