global using static Exomia.Vulkan.Api.Win32.VkKhrWin32KeyedMutex;
...
/// <summary>
///    VK_KHR_win32_keyed_mutex - device extension (nr. 76) - author 'KHR' [platform 'win32' | contact 'Carsten Rohde @crohde']<br/>
...
public static unsafe partial class VkKhrWin32KeyedMutex
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_WIN32_KEYED_MUTEX_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
