...
/// <summary> VkWin32KeyedMutexAcquireReleaseInfoNV - Use Windows keyex mutex mechanism to synchronize work - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkWin32KeyedMutexAcquireReleaseInfoNV.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkWin32KeyedMutexAcquireReleaseInfoNV.html</a></summary>
    /// <remarks><list type="table">
    ///     <item><term>structextends</term><description>VkSubmitInfo,VkSubmitInfo2</description></item>
    /// </list></remarks>
...
public unsafe struct VkWin32KeyedMutexAcquireReleaseInfoNV {
    ...
    /// <summary> VUID-VkWin32KeyedMutexAcquireReleaseInfoNV-sType-sType sType must be VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV</summary>
    public VkStructureType sType;
    /// <summary>pNext is NULL or a pointer to a structure extending this structure.</summary>
    public void* pNext;
    /// <summary>acquireCount is the number of entries in the pAcquireSyncs, pAcquireKeys, and pAcquireTimeoutMilliseconds arrays.</summary>
    ...
    /// <summary>pAcquireTimeoutMilliseconds is a pointer to an array of timeout values, in millisecond units, for each acquire specified in pAcquireKeys.</summary>
