...
/// <summary>
///    VK_NV_win32_keyed_mutex - device extension (nr. 59) - author 'NV' [platform 'win32' | contact 'Carsten Rohde @crohde']<br/>
...
public static unsafe partial class VkNvWin32KeyedMutex
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_NV_WIN32_KEYED_MUTEX_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
