...
/// <summary>
///    VK_EXT_full_screen_exclusive - device extension (nr. 256) - author 'EXT' [platform 'win32' | contact 'James Jones @cubanismo']<br/>
...
public static unsafe partial class VkExtFullScreenExclusive
{
    ...
    ///     }
    /// </remarks>
    public const string VK_EXT_FULL_SCREEN_EXCLUSIVE_EXTENSION_NAME_UTF8_NT = "\u4b56\u455f\u5458\u465f\u4c55\u5f4c\u4353\u4552\u4e45\u455f\u4358\u554c\u4953\u4556\u455f\u5458\u4e45\u4953\u4e4f\u4e5f\u4d41\u0045";

    /// <summary> vkGetPhysicalDeviceSurfacePresentModes2EXT - Query supported presentation modes - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceSurfacePresentModes2EXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceSurfacePresentModes2EXT.html</a> </summary>
    ...
    ///     <item><term>errorcodes</term><description>VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_SURFACE_LOST_KHR</description></item>
    /// </list></remarks>
    ...
    /// <summary> vkAcquireFullScreenExclusiveModeEXT - Acquire full-screen exclusive mode for a swapchain - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkAcquireFullScreenExclusiveModeEXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkAcquireFullScreenExclusiveModeEXT.html</a> </summary>
    ...
    ///     <item><term>errorcodes</term><description>VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_INITIALIZATION_FAILED,VK_ERROR_SURFACE_LOST_KHR</description></item>
    /// </list></remarks>
    public static readonly delegate*<
        VkDevice /*device*/, 
    ...
    /// <summary> vkReleaseFullScreenExclusiveModeEXT - Release full-screen exclusive mode from a swapchain - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkReleaseFullScreenExclusiveModeEXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkReleaseFullScreenExclusiveModeEXT.html</a> </summary>
    /// <param name="device">device is the device associated with swapchain.</param>
    ...
    /// <summary> vkGetDeviceGroupSurfacePresentModes2EXT - Query device group present capabilities for a surface - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDeviceGroupSurfacePresentModes2EXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetDeviceGroupSurfacePresentModes2EXT.html</a> </summary>
    ...
    public static void Load(VkDevice device) {
        fixed(delegate*<VkPhysicalDevice, VkPhysicalDeviceSurfaceInfo2KHR*, uint*, VkPresentModeKHR*, VkResult>* pvkGetPhysicalDeviceSurfacePresentModes2EXT = &vkGetPhysicalDeviceSurfacePresentModes2EXT) 
        {
            *pvkGetPhysicalDeviceSurfacePresentModes2EXT = (delegate*<VkPhysicalDevice, VkPhysicalDeviceSurfaceInfo2KHR*, uint*, VkPresentModeKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u5074\u7968\u6973\u6163\u446c\u7665\u6369\u5365\u7275\u6166\u6563\u7250\u7365\u6e65\u4d74\u646f\u7365\u4532\u5458\u0000");
        }
        fixed(delegate*<VkDevice, VkSwapchainKHR, VkResult>* pvkAcquireFullScreenExclusiveModeEXT = &vkAcquireFullScreenExclusiveModeEXT) 
        {
            *pvkAcquireFullScreenExclusiveModeEXT = (delegate*<VkDevice, VkSwapchainKHR, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6341\u7571\u7269\u4665\u6c75\u536c\u7263\u6565\u456e\u6378\u756c\u6973\u6576\u6f4d\u6564\u5845\u0054");
        }
        fixed(delegate*<VkDevice, VkSwapchainKHR, VkResult>* pvkReleaseFullScreenExclusiveModeEXT = &vkReleaseFullScreenExclusiveModeEXT) 
        {
            *pvkReleaseFullScreenExclusiveModeEXT = (delegate*<VkDevice, VkSwapchainKHR, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6552\u656c\u7361\u4665\u6c75\u536c\u7263\u6565\u456e\u6378\u756c\u6973\u6576\u6f4d\u6564\u5845\u0054");
        }
        ...
        {
            *pvkGetDeviceGroupSurfacePresentModes2EXT = (delegate*<VkDevice, VkPhysicalDeviceSurfaceInfo2KHR*, VkDeviceGroupPresentModeFlagsKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4474\u7665\u6369\u4765\u6f72\u7075\u7553\u6672\u6361\u5065\u6572\u6573\u746e\u6f4d\u6564\u3273\u5845\u0054");
        }
    }
}
