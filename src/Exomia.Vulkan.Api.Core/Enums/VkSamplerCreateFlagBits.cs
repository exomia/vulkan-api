...
public enum VkSamplerCreateFlagBits
{
    ...
    /// <summary> VK_SAMPLER_CREATE_SUBSAMPLED_COARSE_RECONSTRUCTION_BIT_EXTspecifies that the implementation may use approximations when reconstructing a full color value for texture access from a subsampled image. </summary>
    ...
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#textures-cubemapedge"> cube map edge handling </a>
    ///     is not performed.
    /// </summary>
