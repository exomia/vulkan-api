...
public enum VkSamplerReductionMode
{
    ...
    /// <summary>
    ///     VK_SAMPLER_REDUCTION_MODE_MIN specifies that texel values are combined by taking the component-wise minimum of
    ///     values in the footprint with non-zero weights.
    /// </summary>
    VK_SAMPLER_REDUCTION_MODE_MIN = 1,

    /// <summary>
    ///     VK_SAMPLER_REDUCTION_MODE_MAX specifies that texel values are combined by taking the component-wise maximum of
    ///     values in the footprint with non-zero weights.
    /// </summary>
