...
{
    /// <summary> VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT specifies handles of this type can be exported from Vulkan fence objects. </summary>
    VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT = 0x1,

    /// <summary> VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE_BIT specifies handles of this type can be imported to Vulkan fence objects. </summary>
