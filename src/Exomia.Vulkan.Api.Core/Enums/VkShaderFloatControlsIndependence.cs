...
/// <summary>
///     VkShaderFloatControlsIndependence - Bitmask specifying whether, and how, shader float controls can be set
///     separately -
///     <a
...
public enum VkShaderFloatControlsIndependence
{
    ...
    /// <summary>
    ///     VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL specifies that shader float controls for all bit widths can be set
    ///     independently.
    /// </summary>
    VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL = 1,

    /// <summary>
    ///     VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE specifies that shader float controls for all bit widths must be set
    ///     identically.
    /// </summary>
