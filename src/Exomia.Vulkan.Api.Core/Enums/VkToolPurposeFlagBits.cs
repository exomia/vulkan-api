...
public enum VkToolPurposeFlagBits
{
    ...
    /// <summary> VK_TOOL_PURPOSE_TRACING_BIT specifies that the tool is capturing data about the application&#8217;s API usage, including anything from simple logging to capturing data for later replay. </summary>
    VK_TOOL_PURPOSE_TRACING_BIT = 0x4,

    /// <summary> VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT specifies that the tool provides additional API features/extensions on top of the underlying implementation. </summary>
    VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT = 0x8,

    /// <summary> VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT specifies that the tool modifies the API features/limits/extensions presented to the application. </summary>
    VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT = 0x10,

    /// <summary>
    ///     VK_TOOL_PURPOSE_DEBUG_REPORTING_BIT_EXT specifies that the tool reports additional information to the application via callbacks specified by
    ...
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#debugging-debug-markers"> debug markers </a>
    ///     or
    ///     <a
    ...
    ///     </a>
    ///     ,
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#debugging-queue-labels"> queue labels </a>
    ///     , or
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#debugging-command-buffer-labels"> command buffer labels </a>
    /// </summary>
