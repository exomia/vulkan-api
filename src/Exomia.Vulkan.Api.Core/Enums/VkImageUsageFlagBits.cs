...
public enum VkImageUsageFlagBits
{
    ...
    /// <summary> VK_IMAGE_USAGE_SAMPLED_BIT specifies that the image can be used to create a VkImageView suitable for occupying a VkDescriptorSet slot either of type VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE or VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, and be sampled by a shader. </summary>
    VK_IMAGE_USAGE_SAMPLED_BIT = 0x4,

    /// <summary> VK_IMAGE_USAGE_STORAGE_BIT specifies that the image can be used to create a VkImageView suitable for occupying a VkDescriptorSet slot of type VK_DESCRIPTOR_TYPE_STORAGE_IMAGE. </summary>
    VK_IMAGE_USAGE_STORAGE_BIT = 0x8,

    /// <summary> VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT specifies that the image canbe used to create a VkImageView suitable for use as a color or resolve attachment in a VkFramebuffer. </summary>
    VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT = 0x10,

    /// <summary> VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT specifies that the image can be used to create a VkImageView suitable for use as a depth/stencil or depth/stencil resolve attachment in a VkFramebuffer. </summary>
    ...
    ///     with the VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT to back an image with this usage. This bit can be set for any image that can be used to create a VkImageView suitable for use as a color, resolve, depth/stencil, or input attachment.
    /// </summary>
    VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT = 0x40,

    /// <summary> VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT specifies that the image canbe used to create a VkImageView suitable for occupying VkDescriptorSet slot of type VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT; be read from a shader as an input attachment; and be used as an input attachment in a framebuffer. </summary>
    ...
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#video-picture-resources"> DPB Video Picture Resource </a>
    ///     , representing a
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#reference-picture"> reference picture </a>
    ///     . If an implementation requires separate allocations for DPB and decode output, indicating this by returning VK_ERROR_FORMAT_NOT_SUPPORTEDto any
    ///     <a
    ...
    /// <summary>
    ///     VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT specifies that the image can be used to create a VkImageView suitable for use as a
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#fragmentdensitymapops"> fragment density map image </a>
    ///     .
    /// </summary>
    VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT = 0x200,

    /// <summary>
    ///     VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR specifies     that the image can be used to create a VkImageView suitable for     use as a
    ///     <a
    ...
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#encode-input-picture"> input picture </a>
    ///     for
    ...
    ///     <a href="https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#reconstructed-picture"> reconstructed picture </a>
    ...
    /// <summary> VK_IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT specifies that the image can be transitioned to the VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT layout to be used as a color or depth/stencil attachment in a VkFramebufferand/or as a read-only input resource in a shader (sampled image, combined image sampler or input attachment) in the same render pass. </summary>
