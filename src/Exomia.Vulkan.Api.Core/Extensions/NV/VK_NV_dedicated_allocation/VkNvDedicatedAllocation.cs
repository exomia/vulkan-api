...
/// <summary>
///     VK_NV_dedicated_allocation - device extension (nr. 27) - author 'NV' [platform '' | contact 'Jeff Bolz
///     @jeffbolznv']<br />
...
public static class VkNvDedicatedAllocation
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_NV_DEDICATED_ALLOCATION_EXTENSION_NAME" /> represented by an
    ///     UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
