...
public enum VkCoverageModulationModeNV
{
    ...
    /// <summary> VK_COVERAGE_MODULATION_MODE_RGB_NV specifies that the red, green, and blue components are multiplied by the modulation factor. </summary>
    VK_COVERAGE_MODULATION_MODE_RGB_NV = 1,

    /// <summary> VK_COVERAGE_MODULATION_MODE_ALPHA_NV specifies that the alpha component is multiplied by the modulation factor. </summary>
