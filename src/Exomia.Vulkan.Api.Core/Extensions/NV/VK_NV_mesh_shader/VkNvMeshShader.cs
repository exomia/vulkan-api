...
/// <summary>
///     VK_NV_mesh_shader - device extension (nr. 203) - author 'NV' [platform '' | contact 'Christoph Kubisch @pixeljetstream']
///     <br />
...
public static unsafe class VkNvMeshShader
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_NV_MESH_SHADER_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
    ...
    /// <param name="taskCount"> taskCount is the number of local workgroups to dispatch in the X dimension. Y and Z dimension are implicitly set to one. </param>
    ...
    public static void Load(VkDevice device)
    {
        ...
        {
            *pvkCmdDrawMeshTasksNV = (delegate*<VkCommandBuffer, uint, uint, void>)GetVkFunction(device, "\u6b76\u6d43\u4464\u6172\u4d77\u7365\u5468\u7361\u736b\u564e\u0000");
        }
        ...
        {
            *pvkCmdDrawMeshTasksIndirectNV = (delegate*<VkCommandBuffer, VkBuffer, VkDeviceSize, uint, uint, void>)GetVkFunction(
        ...
        {
            *pvkCmdDrawMeshTasksIndirectCountNV = (delegate*<VkCommandBuffer, VkBuffer, VkDeviceSize, VkBuffer, VkDeviceSize, uint, uint, void>)GetVkFunction(
                device, "\u6b76\u6d43\u4464\u6172\u4d77\u7365\u5468\u7361\u736b\u6e49\u6964\u6572\u7463\u6f43\u6e75\u4e74\u0056");
        }
    }
}