...
{
    /// <summary>VK_OUT_OF_BAND_QUEUE_TYPE_RENDER_NV specifies that work will be submitted to this queue.</summary>
    VK_OUT_OF_BAND_QUEUE_TYPE_RENDER_NV = 0,

    /// <summary>VK_OUT_OF_BAND_QUEUE_TYPE_PRESENT_NV specifies that this queue will be presented from.</summary>
