...
/// <summary>
///     VkAccelerationStructureSRTMotionInstanceNV - Structure specifying a single acceleration structure SRT motion
...
{
    /// <summary>
    ///     transformT0 is a VkSRTDataNV structure describing a transformation to be applied to the acceleration structure
    ///     at time 0.
    /// </summary>
    public VkSRTDataNV transformT0;

    /// <summary>
    ///     transformT1 is a VkSRTDataNV structure describing a transformation to be applied to the acceleration structure
    ///     at time 1.
    /// </summary>
