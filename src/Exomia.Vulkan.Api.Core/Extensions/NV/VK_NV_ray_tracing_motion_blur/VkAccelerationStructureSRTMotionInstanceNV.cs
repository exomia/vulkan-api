...
///     <a
///         href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkAccelerationStructureSRTMotionInstanceNV.html">
...
{
    /// <summary> transformT0 is a VkSRTDataNV structure describing a transformation to be applied to the acceleration structure at time 0. </summary>
    public VkSRTDataNV transformT0;

    /// <summary> transformT1 is a VkSRTDataNV structure describing a transformation to be applied to the acceleration structure at time 1. </summary>
    public VkSRTDataNV transformT1;

    private uint _bitfield1;
    private uint _bitfield2;

    /// <summary> accelerationStructureReference is either:a device address containing the value obtained from vkGetAccelerationStructureDeviceAddressKHRor vkGetAccelerationStructureHandleNV     (used by device operations which reference acceleration structures) or,a VkAccelerationStructureKHR object (used by host operations which reference acceleration structures). </summary>
    public ulong accelerationStructureReference;

    /// <summary> instanceCustomIndex is a 24-bit user-specified index value accessible to ray shaders in the InstanceCustomIndexKHR built-in. </summary>
    ...
    /// <summary> mask is an 8-bit visibility mask for the geometry. The instance may only be hit if Cull Mask &amp; instance.mask != 0 </summary>
    public uint mask
    {
    ...
    /// <summary> instanceShaderBindingTableRecordOffset is a 24-bit offset used in calculating the hit shader binding table index. </summary>
