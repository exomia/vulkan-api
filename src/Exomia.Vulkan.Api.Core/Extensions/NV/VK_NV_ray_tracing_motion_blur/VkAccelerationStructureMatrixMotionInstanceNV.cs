...
{
    /// <summary> transformT0 is a VkTransformMatrixKHR structure describing a transformation to be applied to the acceleration structure at time 0. </summary>
    public VkTransformMatrixKHR transformT0;

    /// <summary> transformT1 is a VkTransformMatrixKHR structure describing a transformation to be applied to the acceleration structure at time 1. </summary>
