...
{
    /// <summary> shadingRate is a shading rate palette entry that identifies the fragment width and height for the combination of fragment area and per-pixel coverage sample count to control. </summary>
    public VkShadingRatePaletteEntryNV shadingRate;

    /// <summary> sampleCount identifies the per-pixel coverage sample count for the combination of fragment area and coverage sample count to control. </summary>
    public uint sampleCount;

    /// <summary> sampleLocationCount specifies the number of sample locations in the custom ordering. </summary>
    public uint sampleLocationCount;

    /// <summary> pSampleLocations is a pointer to an array of VkCoarseSampleLocationNV structures specifying the location of each sample in the custom ordering. </summary>
