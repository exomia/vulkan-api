...
public unsafe struct VkPhysicalDeviceShadingRateImageFeaturesNV
{
    ...
    /// <summary> shadingRateImage indicates that the implementation supports the use of a shading rate image to derive an effective shading rate for fragment processing. It also indicates that the implementation supports the ShadingRateNV SPIR-V execution mode. </summary>
    public VkBool32 shadingRateImage;

    /// <summary> shadingRateCoarseSampleOrder indicates that the implementation supports a user-configurable ordering of coverage samples in fragments larger than one pixel. </summary>
