...
public unsafe struct VkPipelineViewportShadingRateImageStateCreateInfoNV
{
    ...
    /// <summary> viewportCount specifies the number of per-viewport palettes used to translate values stored in shading rate images. </summary>
    public uint viewportCount;

    /// <summary> pShadingRatePalettes is a pointer to an array of VkShadingRatePaletteNV structures defining the palette for each viewport. If the shading rate palette state is dynamic, this member is ignored. </summary>
