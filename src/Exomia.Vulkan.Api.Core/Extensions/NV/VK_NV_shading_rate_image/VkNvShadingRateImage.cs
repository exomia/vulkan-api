...
public static unsafe class VkNvShadingRateImage
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_NV_SHADING_RATE_IMAGE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
    ...
    /// <param name="imageView"> imageView is an image view handle specifying the shading rate image. imageView may be set to VK_NULL_HANDLE, which is equivalent to specifying a view of an image filled with zero values. </param>
    /// <param name="imageLayout"> imageLayout is the layout that the image subresources accessible from imageView will be in when the shading rate image is accessed. </param>
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="firstViewport"> firstViewport is the index of the first viewport whose shading rate palette is updated by the command. </param>
    /// <param name="viewportCount"> viewportCount is the number of viewports whose shading rate palettes are updated by the command. </param>
    /// <param name="pShadingRatePalettes"> pShadingRatePalettes is a pointer to an array of VkShadingRatePaletteNV structures defining the palette for each viewport. </param>
    public static readonly delegate*<
        VkCommandBuffer /*commandBuffer*/,
        uint /*firstViewport*/,
        uint /*viewportCount*/,
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="sampleOrderType"> sampleOrderType specifies the mechanism used to order coverage samples in fragments larger than one pixel. </param>
    /// <param name="customSampleOrderCount"> customSampleOrderCount specifies the number of custom sample orderings to use when ordering coverage samples. </param>
    /// <param name="pCustomSampleOrders"> pCustomSampleOrders is a pointer to an array of VkCoarseSampleOrderCustomNV structures, each structure specifying the coverage sample order for a single combination of fragment area and coverage sample count. </param>
    public static readonly delegate*<
        VkCommandBuffer /*commandBuffer*/,
