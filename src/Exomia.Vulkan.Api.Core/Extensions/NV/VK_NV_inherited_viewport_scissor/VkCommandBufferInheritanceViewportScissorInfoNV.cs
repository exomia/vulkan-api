...
public unsafe struct VkCommandBufferInheritanceViewportScissorInfoNV
{
    ...
    /// <summary>
    ///     viewportDepthCount specifies the maximum number of viewports to inherit. When viewportScissor2D is VK_FALSE,
    ///     the behavior is as if this value is zero.
    /// </summary>
    public uint viewportDepthCount;

    /// <summary>
    ///     pViewportDepths is a pointer to a VkViewport structure specifying the expected depth range for each inherited
    ///     viewport.
    /// </summary>
