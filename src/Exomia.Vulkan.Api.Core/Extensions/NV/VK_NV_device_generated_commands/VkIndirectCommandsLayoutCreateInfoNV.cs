...
public unsafe struct VkIndirectCommandsLayoutCreateInfoNV
{
    ...
    /// <summary> pTokens is an array describing each command token in detail. See VkIndirectCommandsTokenTypeNV and VkIndirectCommandsLayoutTokenNV below for details. </summary>
