...
{
    /// <summary> data encodes packed state that this command alters.Bit 0: If set represents VK_FRONT_FACE_CLOCKWISE, otherwise VK_FRONT_FACE_COUNTER_CLOCKWISE </summary>
    public uint data;
}