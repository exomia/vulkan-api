...
public unsafe struct VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV
{
    ...
    /// <summary> maxGraphicsShaderGroupCount is the maximum number of shader groups in VkGraphicsPipelineShaderGroupsCreateInfoNV. </summary>
    public uint maxGraphicsShaderGroupCount;

    /// <summary> maxIndirectSequenceCount is the maximum number of sequences in VkGeneratedCommandsInfoNV and in VkGeneratedCommandsMemoryRequirementsInfoNV. </summary>
    ...
    /// <summary> minSequencesCountBufferOffsetAlignment is the minimum alignment for memory addresses which can be used in VkGeneratedCommandsInfoNV. </summary>
    public uint minSequencesCountBufferOffsetAlignment;

    /// <summary> minSequencesIndexBufferOffsetAlignment is the minimum alignment for memory addresses which can be used in VkGeneratedCommandsInfoNV. </summary>
    public uint minSequencesIndexBufferOffsetAlignment;

    /// <summary> minIndirectCommandsBufferOffsetAlignment is the minimum alignment for memory addresses used in VkIndirectCommandsStreamNV, and as preprocess buffer in VkGeneratedCommandsInfoNV. </summary>
