...
public unsafe struct VkGeneratedCommandsMemoryRequirementsInfoNV
{
    ...
    /// <summary> pipelineBindPoint is the VkPipelineBindPoint of the pipeline that this buffer memory is intended to be used with during the execution. </summary>
    ...
    /// <summary> maxSequencesCount is the maximum number of sequences that this buffer memory in combination with the other state provided can be used with. </summary>
