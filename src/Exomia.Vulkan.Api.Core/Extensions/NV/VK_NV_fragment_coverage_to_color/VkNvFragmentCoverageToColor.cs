...
/// <summary>
///     VK_NV_fragment_coverage_to_color - device extension (nr. 150) - author 'NV' [platform '' | contact 'Jeff Bolz
///     @jeffbolznv']<br />
///     <a
...
public static class VkNvFragmentCoverageToColor
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_NV_FRAGMENT_COVERAGE_TO_COLOR_EXTENSION_NAME" /> represented
    ///     by an UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
