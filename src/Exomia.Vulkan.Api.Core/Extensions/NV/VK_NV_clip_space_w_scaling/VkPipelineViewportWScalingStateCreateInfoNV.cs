...
public unsafe struct VkPipelineViewportWScalingStateCreateInfoNV
{
    ...
    /// <summary> viewportCount is the number of viewports used by W scaling, and must match the number of viewports in the pipeline if viewport Wscaling is enabled. </summary>
    public uint viewportCount;

    /// <summary> pViewportWScalings is a pointer to an array of VkViewportWScalingNV structures defining the W scaling parameters for the corresponding viewports. If the viewport W scaling state is dynamic, this member is ignored. </summary>
