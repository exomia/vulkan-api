...
public unsafe struct VkPhysicalDeviceRayTracingPropertiesNV
{
    ...
    /// <summary> maxTriangleCount is the maximum number of triangles in all geometries in the bottom level acceleration structure. </summary>
    public ulong maxTriangleCount;

    /// <summary> maxDescriptorSetAccelerationStructures is the maximum number of acceleration structure descriptors that are allowed in a descriptor set. </summary>
