...
public unsafe struct VkAccelerationStructureInfoNV
{
    ...
    /// <summary> type is a VkAccelerationStructureTypeNV value specifying the type of acceleration structure that will be created. </summary>
    public VkAccelerationStructureTypeNV type;

    /// <summary> flags is a bitmask of VkBuildAccelerationStructureFlagBitsNVspecifying additional parameters of the acceleration structure. </summary>
    ...
    /// <summary> pGeometries is a pointer to an array of geometryCountVkGeometryNV structures containing the scene data being passed into the acceleration structure. </summary>
