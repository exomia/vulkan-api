...
public unsafe struct VkAccelerationStructureCreateInfoNV
{
    ...
    /// <summary> compactedSize is the size from the result of vkCmdWriteAccelerationStructuresPropertiesNV if this acceleration structure is going to be the target of a compacting copy. </summary>
    public VkDeviceSize compactedSize;

    /// <summary> info is the VkAccelerationStructureInfoNV structure specifying further parameters of the created acceleration structure. </summary>
