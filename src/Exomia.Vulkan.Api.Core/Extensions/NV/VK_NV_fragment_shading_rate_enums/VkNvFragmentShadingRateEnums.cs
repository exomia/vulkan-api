...
/// <summary>
///     VK_NV_fragment_shading_rate_enums - device extension (nr. 327) - author 'NV' [platform '' | contact 'Pat Brown @nvpbrown']
///     <br />
///     <a
...
public static unsafe class VkNvFragmentShadingRateEnums
{
    ...
    /// <param name="shadingRate"> shadingRate specifies a VkFragmentShadingRateNV enum indicating the pipeline fragment shading rate for subsequent drawing commands. </param>
