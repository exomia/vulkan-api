...
/// <summary>
///     VK_NV_shader_image_footprint - device extension (nr. 205) - author 'NV' [platform '' | contact 'Pat Brown
///     @nvpbrown']<br />
...
public static class VkNvShaderImageFootprint
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_NV_SHADER_IMAGE_FOOTPRINT_EXTENSION_NAME" /> represented by
    ///     an UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
