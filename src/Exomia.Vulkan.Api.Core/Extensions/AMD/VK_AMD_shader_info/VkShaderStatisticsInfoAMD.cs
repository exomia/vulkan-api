...
public struct VkShaderStatisticsInfoAMD
{
    ...
    /// <summary> resourceUsage is a VkShaderResourceUsageAMD structure describing internal physical device resources used by this shader. </summary>
    public VkShaderResourceUsageAMD resourceUsage;

    /// <summary> numPhysicalVgprs is the maximum number of vector instruction general-purpose registers (VGPRs) available to the physical device. </summary>
    public uint numPhysicalVgprs;

    /// <summary> numPhysicalSgprs is the maximum number of scalar instruction general-purpose registers (SGPRs) available to the physical device. </summary>
