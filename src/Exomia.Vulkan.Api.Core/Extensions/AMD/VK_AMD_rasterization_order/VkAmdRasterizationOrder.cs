...
/// <summary>
///     VK_AMD_rasterization_order - device extension (nr. 19) - author 'AMD' [platform '' | contact 'Daniel Rakos @drakos-amd']
///     <br />
...
public static class VkAmdRasterizationOrder
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_AMD_RASTERIZATION_ORDER_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
