...
/// <summary>
///     VK_AMD_shader_ballot - device extension (nr. 38) - author 'AMD' [platform '' | contact 'Dominik Witczak @dominikwitczakamd']
///     <br />
...
public static class VkAmdShaderBallot
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_AMD_SHADER_BALLOT_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
