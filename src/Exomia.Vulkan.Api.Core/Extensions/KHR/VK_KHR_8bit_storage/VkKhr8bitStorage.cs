...
/// <summary>
///     VK_KHR_8bit_storage - device extension (nr. 178) - author 'KHR' [platform '' | contact 'Alexander Galazin @alegal-arm']
///     <br />
...
public static class VkKhr8bitStorage
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_8BIT_STORAGE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
