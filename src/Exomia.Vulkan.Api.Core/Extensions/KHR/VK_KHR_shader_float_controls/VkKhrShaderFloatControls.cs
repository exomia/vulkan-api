...
/// <summary>
///     VK_KHR_shader_float_controls - device extension (nr. 198) - author 'KHR' [platform '' | contact 'Alexander Galazin @alegal-arm']
///     <br />
...
public static class VkKhrShaderFloatControls
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
