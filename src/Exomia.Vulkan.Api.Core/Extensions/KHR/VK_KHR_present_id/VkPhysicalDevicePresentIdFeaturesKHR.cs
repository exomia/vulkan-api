...
public unsafe struct VkPhysicalDevicePresentIdFeaturesKHR
{
    ...
    /// <summary> presentId indicates that the implementation supports specifying present ID values in the VkPresentIdKHRextension to the VkPresentInfoKHR struct. </summary>
