...
/// <summary>
///     VK_KHR_maintenance4 - device extension (nr. 414) - author 'KHR' [platform '' | contact 'Piers Daniell @pdaniell-nv']
///     <br />
...
public static unsafe class VkKhrMaintenance4
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_MAINTENANCE_4_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
