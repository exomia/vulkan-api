...
public static unsafe class VkKhrSwapchain
{
    ...
    ///             <description>VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_DEVICE_LOST,VK_ERROR_SURFACE_LOST_KHR,VK_ERROR_NATIVE_WINDOW_IN_USE_KHR,VK_ERROR_INITIALIZATION_FAILED</description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    public static void Load(VkInstance instance, VkDevice device)
    {
        ...
        {
            *pvkCreateSwapchainKHR = (delegate*<VkDevice, VkSwapchainCreateInfoKHR*, VkAllocationCallbacks*, VkSwapchainKHR*, VkResult>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u7243\u6165\u6574\u7753\u7061\u6863\u6961\u4b6e\u5248\u0000");
        }
        fixed (delegate*<VkDevice, VkSwapchainKHR, VkAllocationCallbacks*, void>* pvkDestroySwapchainKHR = &vkDestroySwapchainKHR)
        {
            *pvkDestroySwapchainKHR = (delegate*<VkDevice, VkSwapchainKHR, VkAllocationCallbacks*, void>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u6544\u7473\u6f72\u5379\u6177\u6370\u6168\u6e69\u484b\u0052");
        }
        fixed (delegate*<VkDevice, VkSwapchainKHR, uint*, VkImage*, VkResult>* pvkGetSwapchainImagesKHR = &vkGetSwapchainImagesKHR)
        {
            *pvkGetSwapchainImagesKHR = (delegate*<VkDevice, VkSwapchainKHR, uint*, VkImage*, VkResult>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u6547\u5374\u6177\u6370\u6168\u6e69\u6d49\u6761\u7365\u484b\u0052");
        }
        ...
        {
            *pvkAcquireNextImageKHR = (delegate*<VkDevice, VkSwapchainKHR, ulong, VkSemaphore, VkFence, uint*, VkResult>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u6341\u7571\u7269\u4e65\u7865\u4974\u616d\u6567\u484b\u0052");
        }
        fixed (delegate*<VkQueue, VkPresentInfoKHR*, VkResult>* pvkQueuePresentKHR = &vkQueuePresentKHR)
        {
            *pvkQueuePresentKHR = (delegate*<VkQueue, VkPresentInfoKHR*, VkResult>)Core.Vk.GetVkFunction(instance, device, "\u6b76\u7551\u7565\u5065\u6572\u6573\u746e\u484b\u0052");
        }
        fixed (delegate*<VkDevice, VkDeviceGroupPresentCapabilitiesKHR*, VkResult>* pvkGetDeviceGroupPresentCapabilitiesKHR = &vkGetDeviceGroupPresentCapabilitiesKHR)
        {
            *pvkGetDeviceGroupPresentCapabilitiesKHR = (delegate*<VkDevice, VkDeviceGroupPresentCapabilitiesKHR*, VkResult>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u6547\u4474\u7665\u6369\u4765\u6f72\u7075\u7250\u7365\u6e65\u4374\u7061\u6261\u6c69\u7469\u6569\u4b73\u5248\u0000");
        }
        fixed (delegate*<VkDevice, VkSurfaceKHR, VkDeviceGroupPresentModeFlagsKHR*, VkResult>* pvkGetDeviceGroupSurfacePresentModesKHR = &vkGetDeviceGroupSurfacePresentModesKHR)
        {
            *pvkGetDeviceGroupSurfacePresentModesKHR = (delegate*<VkDevice, VkSurfaceKHR, VkDeviceGroupPresentModeFlagsKHR*, VkResult>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u6547\u4474\u7665\u6369\u4765\u6f72\u7075\u7553\u6672\u6361\u5065\u6572\u6573\u746e\u6f4d\u6564\u4b73\u5248\u0000");
        }
        fixed (delegate*<VkPhysicalDevice, VkSurfaceKHR, uint*, VkRect2D*, VkResult>* pvkGetPhysicalDevicePresentRectanglesKHR = &vkGetPhysicalDevicePresentRectanglesKHR)
        {
            *pvkGetPhysicalDevicePresentRectanglesKHR = (delegate*<VkPhysicalDevice, VkSurfaceKHR, uint*, VkRect2D*, VkResult>)Core.Vk.GetVkFunction(
                instance, device, "\u6b76\u6547\u5074\u7968\u6973\u6163\u446c\u7665\u6369\u5065\u6572\u6573\u746e\u6552\u7463\u6e61\u6c67\u7365\u484b\u0052");
        }
