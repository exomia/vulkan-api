    ...
    public static void Load(VkDevice device)
    {
        ...
        fixed (delegate*<VkDevice, VkSwapchainKHR, VkAllocationCallbacks*, void>* pvkDestroySwapchainKHR = &vkDestroySwapchainKHR)
        {
            *pvkDestroySwapchainKHR =
                (delegate*<VkDevice, VkSwapchainKHR, VkAllocationCallbacks*, void>)Core.Vk.GetVkFunction(device, "\u6b76\u6544\u7473\u6f72\u5379\u6177\u6370\u6168\u6e69\u484b\u0052");
        }
        ...
        {
            *pvkQueuePresentKHR = (delegate*<VkQueue, VkPresentInfoKHR*, VkResult>)Core.Vk.GetVkFunction(device, "\u6b76\u7551\u7565\u5065\u6572\u6573\u746e\u484b\u0052");
        }
