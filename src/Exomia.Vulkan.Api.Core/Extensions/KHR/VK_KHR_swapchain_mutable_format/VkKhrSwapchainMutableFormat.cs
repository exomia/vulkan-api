...
/// <summary>
///     VK_KHR_swapchain_mutable_format - device extension (nr. 201) - author 'KHR' [platform '' | contact 'Daniel Rakos @drakos-arm']
///     <br />
///     <a
...
///     </a>
/// </summary>
[VkRequires("VK_KHR_swapchain,VK_KHR_maintenance2,VK_KHR_image_format_list")]
public static class VkKhrSwapchainMutableFormat
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_SWAPCHAIN_MUTABLE_FORMAT_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
