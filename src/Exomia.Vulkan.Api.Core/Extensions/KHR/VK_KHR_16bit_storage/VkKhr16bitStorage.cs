...
/// <summary>
///     VK_KHR_16bit_storage - device extension (nr. 84) - author 'KHR' [platform '' | contact 'Jan-Harald Fredriksen @janharaldfredriksen-arm']
///     <br />
...
public static class VkKhr16bitStorage
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_16BIT_STORAGE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
