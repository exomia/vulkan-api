...
public unsafe struct VkPerformanceCounterKHR
{
    ...
    /// <summary> uuid is an array of size VK_UUID_SIZE, containing 8-bit values that represent a universally unique identifier for the counter of the physical device. </summary>
