...
public unsafe struct VkPerformanceCounterDescriptionKHR
{
    ...
    /// <summary> flags is a bitmask of VkPerformanceCounterDescriptionFlagBitsKHR indicating the usage behavior for the counter. </summary>
    public VkPerformanceCounterDescriptionFlagsKHR flags;

    /// <summary> name is an array of size VK_MAX_DESCRIPTION_SIZE, containing a null-terminated UTF-8 string specifying the name of the counter. </summary>
    public fixed byte name[(int)VK_MAX_DESCRIPTION_SIZE];

    /// <summary> category is an array of size VK_MAX_DESCRIPTION_SIZE, containing a null-terminated UTF-8 string specifying the category of the counter. </summary>
    public fixed byte category[(int)VK_MAX_DESCRIPTION_SIZE];

    /// <summary> description is an array of size VK_MAX_DESCRIPTION_SIZE, containing a null-terminated UTF-8 string specifying the description of the counter. </summary>
