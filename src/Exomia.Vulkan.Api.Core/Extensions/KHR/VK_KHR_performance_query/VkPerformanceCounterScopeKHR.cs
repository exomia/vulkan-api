...
{
    /// <summary>
    ///     VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR - the performance counter scope is a single complete command
    ///     buffer.
    /// </summary>
    VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR = 0,

    /// <summary>
    ///     VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR - the performance counter scope is zero or more complete render
    ///     passes. The performance query containing the performance counter must begin and end outside a render pass instance.
    /// </summary>
