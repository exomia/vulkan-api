...
public unsafe struct VkPhysicalDeviceAccelerationStructureFeaturesKHR
{
    ...
    /// <summary> accelerationStructure indicates whether the implementation supports the acceleration structure functionality. See Acceleration Structures. </summary>
    public VkBool32 accelerationStructure;

    /// <summary> accelerationStructureCaptureReplay indicates whether the implementation supports saving and reusing acceleration structure device addresses, e.g. for trace capture and replay. </summary>
    public VkBool32 accelerationStructureCaptureReplay;

    /// <summary> accelerationStructureIndirectBuild indicates whether the implementation supports indirect acceleration structure build commands, e.g. vkCmdBuildAccelerationStructuresIndirectKHR. </summary>
    public VkBool32 accelerationStructureIndirectBuild;

    /// <summary> accelerationStructureHostCommands indicates whether the implementation supports host side acceleration structure commands, e.g. vkBuildAccelerationStructuresKHR, vkCopyAccelerationStructureKHR, vkCopyAccelerationStructureToMemoryKHR, vkCopyMemoryToAccelerationStructureKHR, vkWriteAccelerationStructuresPropertiesKHR. </summary>
    public VkBool32 accelerationStructureHostCommands;

    /// <summary> descriptorBindingAccelerationStructureUpdateAfterBind indicates whether the implementation supports updating acceleration structure descriptors after a set is bound. If this feature is not enabled, VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT must not be used with VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR. </summary>
