...
public unsafe struct VkPipelineExecutableInfoKHR
{
    ...
    /// <summary> executableIndex is the index of the pipeline executable to query in the array of executable properties returned by vkGetPipelineExecutablePropertiesKHR. </summary>
