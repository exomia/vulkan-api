...
public unsafe struct VkPipelineExecutablePropertiesKHR
{
    ...
    /// <summary> stages is a bitmask of zero or more VkShaderStageFlagBitsindicating which shader stages (if any) were principally used as inputs to compile this pipeline executable. </summary>
    public VkShaderStageFlags stages;

    /// <summary> name is an array of VK_MAX_DESCRIPTION_SIZE charcontaining a null-terminated UTF-8 string which is a short human readable name for this pipeline executable. </summary>
    public fixed byte name[(int)VK_MAX_DESCRIPTION_SIZE];

    /// <summary> description is an array of VK_MAX_DESCRIPTION_SIZE charcontaining a null-terminated UTF-8 string which is a human readable description for this pipeline executable. </summary>
