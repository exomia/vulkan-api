...
public unsafe struct VkDisplaySurfaceCreateInfoKHR
{
    ...
    /// <summary> transform is a VkSurfaceTransformFlagBitsKHR value specifying the transformation to apply to images as part of the scanout operation. </summary>
    public VkSurfaceTransformFlagBitsKHR transform;

    /// <summary> globalAlpha is the global alpha value. This value is ignored if alphaMode is not VK_DISPLAY_PLANE_ALPHA_GLOBAL_BIT_KHR. </summary>
