...
/// <summary>
///     VK_KHR_driver_properties - device extension (nr. 197) - author 'KHR' [platform '' | contact 'Daniel Rakos @drakos-amd']
///     <br />
...
public static class VkKhrDriverProperties
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_DRIVER_PROPERTIES_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
