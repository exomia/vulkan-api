...
/// <summary>
///     VK_KHR_vulkan_memory_model - device extension (nr. 212) - author 'KHR' [platform '' | contact 'Jeff Bolz @jeffbolznv']
///     <br />
...
public static class VkKhrVulkanMemoryModel
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
