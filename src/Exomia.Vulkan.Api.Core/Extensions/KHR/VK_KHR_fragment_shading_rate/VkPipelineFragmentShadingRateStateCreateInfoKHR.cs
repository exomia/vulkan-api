...
public unsafe struct VkPipelineFragmentShadingRateStateCreateInfoKHR
{
    ...
    /// <summary> fragmentSize specifies a VkExtent2D structure containing the fragment size used to define the pipeline fragment shading rate for drawing commands using this pipeline. </summary>
    public VkExtent2D fragmentSize;

    /// <summary> combinerOps specifies a VkFragmentShadingRateCombinerOpKHRvalue determining how the pipeline, primitive, and attachment shading ratesare combined for fragments generated by drawing commands using the created pipeline. </summary>
