...
public static unsafe class VkKhrMaintenance3
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_KHR_MAINTENANCE_3_EXTENSION_NAME" /> represented by an UTF16
    ///     string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_KHR_MAINTENANCE3_EXTENSION_NAME" /> represented by an UTF16
    ///     string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
