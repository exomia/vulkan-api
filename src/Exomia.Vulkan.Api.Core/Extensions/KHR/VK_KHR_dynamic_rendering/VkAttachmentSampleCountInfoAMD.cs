...
public unsafe struct VkAttachmentSampleCountInfoAMD
{
    ...
    /// <summary> pColorAttachmentSamples is a pointer to an array of VkSampleCountFlagBits values defining the sample count of color attachments. </summary>
    public VkSampleCountFlagBits* pColorAttachmentSamples;

    /// <summary> depthStencilAttachmentSamples is a VkSampleCountFlagBitsvalue defining the sample count of a depth/stencil attachment. </summary>
