...
/// <summary>
///     VK_KHR_depth_stencil_resolve - device extension (nr. 200) - author 'KHR' [platform '' | contact 'Jan-Harald Fredriksen @janharald']
///     <br />
...
/// </summary>
[VkRequires("VK_KHR_create_renderpass2")]
...
public static class VkKhrDepthStencilResolve
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_DEPTH_STENCIL_RESOLVE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
