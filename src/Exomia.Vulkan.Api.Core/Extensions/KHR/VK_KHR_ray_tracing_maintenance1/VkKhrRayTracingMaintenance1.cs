...
/// <summary>
///     VK_KHR_ray_tracing_maintenance1 - device extension (nr. 387) - author 'KHR' [platform '' | contact 'Daniel Koch @dgkoch']
///     <br />
///     <a
...
public static unsafe class VkKhrRayTracingMaintenance1
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_RAY_TRACING_MAINTENANCE_1_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
    ...
    /// <param name="indirectDeviceAddress"> indirectDeviceAddress is a buffer device address which is a pointer to a VkTraceRaysIndirectCommand2KHR structure containing the trace ray parameters. </param>
