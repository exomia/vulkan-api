...
public unsafe struct VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR
{
    ...
    /// <summary> rayTracingMaintenance1indicates that the implementation supports the following:The CullMaskKHR SPIR-V builtin using the SPV_KHR_ray_cull_maskSPIR-V extension.Additional acceleration structure property queries: VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_BOTTOM_LEVEL_POINTERS_KHRand VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SIZE_KHR.A new access flag VK_ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR.A new pipeline stage flag bit VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR </summary>
    public VkBool32 rayTracingMaintenance1;

    /// <summary> rayTracingPipelineTraceRaysIndirect2 indicates whether the implementation supports the extended indirect ray tracing command vkCmdTraceRaysIndirect2KHR. </summary>
