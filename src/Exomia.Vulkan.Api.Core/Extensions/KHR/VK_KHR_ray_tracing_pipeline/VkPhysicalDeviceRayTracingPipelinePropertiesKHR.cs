...
public unsafe struct VkPhysicalDeviceRayTracingPipelinePropertiesKHR
{
    ...
    /// <summary> shaderGroupHandleCaptureReplaySize is the number of bytes for the information required to do capture and replay for shader group handles. </summary>
    public uint shaderGroupHandleCaptureReplaySize;

    /// <summary> maxRayDispatchInvocationCount is the maximum number of ray generation shader invocations which may be produced by a single vkCmdTraceRaysIndirectKHR or vkCmdTraceRaysKHR command. </summary>
    public uint maxRayDispatchInvocationCount;

    /// <summary> shaderGroupHandleAlignment is the required alignment in bytes for each shader binding table entry. The value must be a power of two. </summary>
