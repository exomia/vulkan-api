...
public unsafe struct VkRayTracingPipelineCreateInfoKHR
{
    ...
    /// <summary> pStages is a pointer to an array of stageCountVkPipelineShaderStageCreateInfo structures describing the set of the shader stages to be included in the ray tracing pipeline. </summary>
    public VkPipelineShaderStageCreateInfo* pStages;

    /// <summary> groupCount is the number of entries in the pGroups array. </summary>
    public uint groupCount;

    /// <summary> pGroups is a pointer to an array of groupCountVkRayTracingShaderGroupCreateInfoKHR structures describing the set of the shader stages to be included in each shader group in the ray tracing pipeline. </summary>
    ...
    /// <summary> pLibraryInfo is a pointer to a VkPipelineLibraryCreateInfoKHR structure defining pipeline libraries to include. </summary>
    public VkPipelineLibraryCreateInfoKHR* pLibraryInfo;

    /// <summary> pLibraryInterface is a pointer to a VkRayTracingPipelineInterfaceCreateInfoKHR structure defining additional information when using pipeline libraries. </summary>
    public VkRayTracingPipelineInterfaceCreateInfoKHR* pLibraryInterface;

    /// <summary> pDynamicState is a pointer to a VkPipelineDynamicStateCreateInfo structure, and is used to indicate which properties of the pipeline state object are dynamic and can be changed independently of the pipeline state. This can be NULL, which means no state in the pipeline is considered dynamic. </summary>
