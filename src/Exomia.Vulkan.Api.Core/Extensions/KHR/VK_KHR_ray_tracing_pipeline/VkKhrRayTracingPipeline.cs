...
/// <summary>
///     VK_KHR_ray_tracing_pipeline - device extension (nr. 348) - author 'KHR' [platform '' | contact 'Daniel Koch @dgkoch']
///     <br />
...
public static unsafe class VkKhrRayTracingPipeline
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
    ...
    /// <param name="pRaygenShaderBindingTable"> pRaygenShaderBindingTable is a VkStridedDeviceAddressRegionKHR that holds the shader binding table data for the ray generation shader stage. </param>
    /// <param name="pMissShaderBindingTable"> pMissShaderBindingTable is a VkStridedDeviceAddressRegionKHRthat holds the shader binding table data for the miss shader stage. </param>
    /// <param name="pHitShaderBindingTable"> pHitShaderBindingTable is a VkStridedDeviceAddressRegionKHRthat holds the shader binding table data for the hit shader stage. </param>
    /// <param name="pCallableShaderBindingTable"> pCallableShaderBindingTable is a VkStridedDeviceAddressRegionKHR that holds the shader binding table data for the callable shader stage. </param>
    ...
    /// <param name="deferredOperation"> deferredOperation is VK_NULL_HANDLE or the handle of a valid VkDeferredOperationKHR request deferral object for this command. </param>
    ...
    /// <param name="firstGroup"> firstGroup is the index of the first group to retrieve a handle     for from the VkRayTracingPipelineCreateInfoKHR::pGroupsor VkRayTracingPipelineCreateInfoNV::pGroups    array. </param>
    ...
    /// <param name="device"> device is the logical device containing the ray tracing pipeline. </param>
    /// <param name="pipeline"> pipeline is the ray tracing pipeline object containing the shaders. </param>
    /// <param name="firstGroup"> firstGroup is the index of the first group to retrieve a handle for from the VkRayTracingPipelineCreateInfoKHR::pGroupsarray. </param>
    /// <param name="groupCount"> groupCount is the number of shader handles to retrieve. </param>
    /// <param name="dataSize"> dataSize is the size in bytes of the buffer pointed to by pData. </param>
    /// <param name="pData"> pData is a pointer to a user-allocated buffer where the results will be written. </param>
    /// <remarks>
    ...
    /// <param name="pHitShaderBindingTable"> pHitShaderBindingTable is a VkStridedDeviceAddressRegionKHRthat holds the shader binding table data for the hit shader stage. </param>
    /// <param name="pCallableShaderBindingTable"> pCallableShaderBindingTable is a VkStridedDeviceAddressRegionKHR that holds the shader binding table data for the callable shader stage. </param>
    /// <param name="indirectDeviceAddress"> indirectDeviceAddress is a buffer device address which is a pointer to a VkTraceRaysIndirectCommandKHR structure containing the trace ray parameters. </param>
    public static readonly delegate*<
        VkCommandBuffer /*commandBuffer*/,
        VkStridedDeviceAddressRegionKHR* /*pRaygenShaderBindingTable*/,
        VkStridedDeviceAddressRegionKHR* /*pMissShaderBindingTable*/,
    ...
    public static void Load(VkDevice device)
    {
            ...
            >* pvkCmdTraceRaysKHR = &vkCmdTraceRaysKHR)
        {
            *pvkCmdTraceRaysKHR =
                (delegate*<VkCommandBuffer, VkStridedDeviceAddressRegionKHR*, VkStridedDeviceAddressRegionKHR*, VkStridedDeviceAddressRegionKHR*, VkStridedDeviceAddressRegionKHR*, uint, uint, uint,
                    void>)GetVkFunction(device, "\u6b76\u6d43\u5464\u6172\u6563\u6152\u7379\u484b\u0052");
        }
            ...
            &vkCreateRayTracingPipelinesKHR)
        {
            *pvkCreateRayTracingPipelinesKHR =
                (delegate*<VkDevice, VkDeferredOperationKHR, VkPipelineCache, uint, VkRayTracingPipelineCreateInfoKHR*, VkAllocationCallbacks*, VkPipeline*, VkResult>)GetVkFunction(
        ...
        {
            *pvkGetRayTracingShaderGroupHandlesKHR = (delegate*<VkDevice, VkPipeline, uint, uint, nuint, void*, VkResult>)GetVkFunction(
        ...
        {
            *pvkGetRayTracingCaptureReplayShaderGroupHandlesKHR = (delegate*<VkDevice, VkPipeline, uint, uint, nuint, void*, VkResult>)GetVkFunction(
            ...
            * pvkCmdTraceRaysIndirectKHR = &vkCmdTraceRaysIndirectKHR)
        {
            *pvkCmdTraceRaysIndirectKHR =
                (delegate*<VkCommandBuffer, VkStridedDeviceAddressRegionKHR*, VkStridedDeviceAddressRegionKHR*, VkStridedDeviceAddressRegionKHR*, VkStridedDeviceAddressRegionKHR*, VkDeviceAddress,
                    void>)GetVkFunction(device, "\u6b76\u6d43\u5464\u6172\u6563\u6152\u7379\u6e49\u6964\u6572\u7463\u484b\u0052");
        }
        ...
        {
            *pvkGetRayTracingShaderGroupStackSizeKHR = (delegate*<VkDevice, VkPipeline, uint, VkShaderGroupShaderKHR, VkDeviceSize>)GetVkFunction(
        ...
        {
            *pvkCmdSetRayTracingPipelineStackSizeKHR = (delegate*<VkCommandBuffer, uint, void>)GetVkFunction(
