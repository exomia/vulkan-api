...
public unsafe struct VkValidationCacheCreateInfoEXT
{
    ...
    /// <summary> initialDataSize is the number of bytes in pInitialData. If initialDataSize is zero, the validation cache will initially be empty. </summary>
    public nuint initialDataSize;

    /// <summary> pInitialData is a pointer to previously retrieved validation cache data. If the validation cache data is incompatible (as defined below) with the device, the validation cache will be initially empty. If initialDataSize is zero, pInitialData is ignored. </summary>
