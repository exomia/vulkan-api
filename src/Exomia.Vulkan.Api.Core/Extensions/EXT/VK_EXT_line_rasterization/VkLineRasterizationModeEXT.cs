...
public enum VkLineRasterizationModeEXT
{
    ...
    ///     defined in
    ///     <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#primsrast-lines-basic">
    ///         Basic
    ...
    /// <summary>
    ///     VK_LINE_RASTERIZATION_MODE_RECTANGULAR_EXT specifies lines drawn as if they were rectangles extruded from the
    ///     line
    /// </summary>
    VK_LINE_RASTERIZATION_MODE_RECTANGULAR_EXT = 1,

    /// <summary>
    ///     VK_LINE_RASTERIZATION_MODE_BRESENHAM_EXT specifies lines drawn by determining which pixel diamonds the line
    ///     intersects and exits, as defined in
    ///     <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#primsrast-lines-bresenham">
    ///         Bresenham
    ///         Line Segment Rasterization
    ///     </a>
    ///     .
    ...
    /// <summary>
    ///     VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH_EXT specifies lines drawn if they were rectangles extruded from the
    ///     line, with alpha falloff, as defined in
    ///     <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#primsrast-lines-smooth">
    ///         Smooth
    ///         Lines
    ///     </a>
    ///     .
