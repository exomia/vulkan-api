...
/// <summary>
///     VK_EXT_depth_clip_enable - device extension (nr. 103) - author 'EXT' [platform '' | contact 'Piers Daniell @pdaniell-nv']
///     <br />
...
public static class VkExtDepthClipEnable
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_DEPTH_CLIP_ENABLE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
