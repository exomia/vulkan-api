...
/// <summary>
///     VK_EXT_mutable_descriptor_type - device extension (nr. 495) - author 'EXT' [platform '' | contact 'Joshua Ashton @Joshua-Ashton,Hans-Kristian Arntzen @HansKristian-Work']
///     <br />
...
public static class VkExtMutableDescriptorType
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
