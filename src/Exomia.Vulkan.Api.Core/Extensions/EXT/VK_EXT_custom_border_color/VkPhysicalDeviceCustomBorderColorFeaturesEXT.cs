...
public unsafe struct VkPhysicalDeviceCustomBorderColorFeaturesEXT
{
    ...
    /// <summary> customBorderColors indicates that the implementation supports providing a borderColor value with one of the following values at sampler creation time:VK_BORDER_COLOR_FLOAT_CUSTOM_EXTVK_BORDER_COLOR_INT_CUSTOM_EXT </summary>
    public VkBool32 customBorderColors;

    /// <summary> customBorderColorWithoutFormat indicates that explicit formats are not required for custom border colors and the value of the formatmember of the VkSamplerCustomBorderColorCreateInfoEXT structure may be VK_FORMAT_UNDEFINED. If this feature bit is not set, applications must provide the VkFormat of the image view(s) being sampled by this sampler in the format member of the VkSamplerCustomBorderColorCreateInfoEXTstructure. </summary>
