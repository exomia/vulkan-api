...
public struct VkSubpassSampleLocationsEXT
{
    ...
    /// <summary> sampleLocationsInfo is the sample locations state to use for the layout transition of the depth/stencil attachment away from the image layout the attachment is used with in the subpass specified in subpassIndex. </summary>
