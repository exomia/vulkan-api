...
/// <summary>
///     VK_EXT_legacy_dithering - device extension (nr. 466) - author 'EXT' [platform '' | contact 'Shahbaz Youssefi @syoussefi']
///     <br />
...
public static class VkExtLegacyDithering
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_LEGACY_DITHERING_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
