...
public unsafe struct VkPhysicalDeviceExtendedDynamicState2FeaturesEXT
{
    ...
    /// <summary> extendedDynamicState2 indicates that the implementation supports the following dynamic states:VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLEVK_DYNAMIC_STATE_PRIMITIVE_RESTART_ENABLEVK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE </summary>
    public VkBool32 extendedDynamicState2;

    /// <summary> extendedDynamicState2LogicOp indicates that the implementation supports the following dynamic state:VK_DYNAMIC_STATE_LOGIC_OP_EXT </summary>
    public VkBool32 extendedDynamicState2LogicOp;

    /// <summary> extendedDynamicState2PatchControlPoints indicates that the implementation supports the following dynamic state:VK_DYNAMIC_STATE_PATCH_CONTROL_POINTS_EXT </summary>
