...
public unsafe struct VkValidationFeaturesEXT
{
    ...
    /// <summary> pEnabledValidationFeatures is a pointer to an array of VkValidationFeatureEnableEXT values specifying the validation features to be enabled. </summary>
    ...
    /// <summary> pDisabledValidationFeatures is a pointer to an array of VkValidationFeatureDisableEXT values specifying the validation features to be disabled. </summary>
