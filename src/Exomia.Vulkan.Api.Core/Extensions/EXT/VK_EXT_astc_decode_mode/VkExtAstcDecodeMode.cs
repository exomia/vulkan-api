...
/// <summary>
///     VK_EXT_astc_decode_mode - device extension (nr. 68) - author 'ARM' [platform '' | contact 'Jan-Harald Fredriksen @janharaldfredriksen-arm']
///     <br />
...
public static class VkExtAstcDecodeMode
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_ASTC_DECODE_MODE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
