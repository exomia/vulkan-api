...
/// <summary>
///     VK_EXT_hdr_metadata - device extension (nr. 106) - author 'GOOGLE' [platform '' | contact 'Courtney Goeltzenleuchter @courtney-g']
///     <br />
...
public static unsafe class VkExtHdrMetadata
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_HDR_METADATA_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
