...
/// <summary>
///     VK_EXT_device_memory_report - device extension (nr. 285) - author 'EXT' [platform '' | contact 'Yiwei Zhang @zhangyiwei']
///     <br />
...
public static class VkExtDeviceMemoryReport
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_DEVICE_MEMORY_REPORT_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
