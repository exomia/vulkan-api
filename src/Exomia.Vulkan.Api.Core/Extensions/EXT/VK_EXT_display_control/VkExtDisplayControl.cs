...
public static unsafe class VkExtDisplayControl
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_EXT_DISPLAY_CONTROL_EXTENSION_NAME" /> represented by an
    ///     UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
    ...
    /// <param name="pDisplayPowerInfo">
    ///     pDisplayPowerInfo is a pointer to a VkDisplayPowerInfoEXTstructure specifying the new
    ///     power state of display.
    /// </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    /// <param name="pDeviceEventInfo">
    ///     pDeviceEventInfo is a pointer to a VkDeviceEventInfoEXTstructure describing the event of
    ...
    /// <param name="pDisplayEventInfo">
    ///     pDisplayEventInfo is a pointer to a VkDisplayEventInfoEXTstructure describing the event
