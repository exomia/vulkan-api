...
public unsafe struct VkPhysicalDeviceFragmentDensityMapFeaturesEXT
{
    ...
    /// <summary> fragmentDensityMap specifies whether the implementation supports render passes with a fragment density map attachment. If this feature is not enabled and the pNext chain of VkRenderPassCreateInfo includes a VkRenderPassFragmentDensityMapCreateInfoEXT structure, fragmentDensityMapAttachment must be VK_ATTACHMENT_UNUSED. </summary>
    public VkBool32 fragmentDensityMap;

    /// <summary> fragmentDensityMapDynamicspecifies whether the implementation supports dynamic fragment density map image views. If this feature is not enabled, VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DYNAMIC_BIT_EXT mustnot be included in VkImageViewCreateInfo::flags. </summary>
    public VkBool32 fragmentDensityMapDynamic;

    /// <summary> fragmentDensityMapNonSubsampledImages specifies whether the implementation supports regular non-subsampled image attachments with fragment density map render passes. If this feature is not enabled, render passes with a fragment density map attachment must only have subsampled attachments bound. </summary>
