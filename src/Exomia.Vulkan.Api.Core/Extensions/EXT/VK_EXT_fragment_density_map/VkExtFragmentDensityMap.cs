...
/// <summary>
///     VK_EXT_fragment_density_map - device extension (nr. 219) - author 'EXT' [platform '' | contact 'Matthew Netsch @mnetsch']
///     <br />
...
public static class VkExtFragmentDensityMap
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_FRAGMENT_DENSITY_MAP_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
