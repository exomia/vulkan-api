...
/// <summary>
///     VK_EXT_debug_report - instance extension (nr. 12) - author 'GOOGLE' [platform '' | contact 'Courtney Goeltzenleuchter @courtney-g']
///     <br />
...
public static unsafe class VkExtDebugReport
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_DEBUG_REPORT_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkDebugReportCallbackCreateInfoEXT structure defining the conditions under which this callback will be called. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pCallback"> pCallback is a pointer to a VkDebugReportCallbackEXT handle in which the created object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    /// <param name="callback"> callback is the VkDebugReportCallbackEXT object to destroy. callback is an externally synchronized object and must not be used on more than one thread at a time. This means that vkDestroyDebugReportCallbackEXT must not be called when a callback is active. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    public static readonly delegate*<
        VkInstance /*instance*/,
    ...
    /// <param name="objectType"> objectType is a VkDebugReportObjectTypeEXT specifying the type of object being used or created at the time the event was triggered. </param>
    /// <param name="object"> object is the object where the issue was detected. object can be VK_NULL_HANDLE if there is no object associated with the event. </param>
    ...
    public static void Load(VkInstance instance)
    {
        ...
        {
            *pvkCreateDebugReportCallbackEXT = (delegate*<VkInstance, VkDebugReportCallbackCreateInfoEXT*, VkAllocationCallbacks*, VkDebugReportCallbackEXT*, VkResult>)GetVkFunction(
        ...
        {
            *pvkDestroyDebugReportCallbackEXT = (delegate*<VkInstance, VkDebugReportCallbackEXT, VkAllocationCallbacks*, void>)GetVkFunction(
        ...
        {
            *pvkDebugReportMessageEXT = (delegate*<VkInstance, VkDebugReportFlagsEXT, VkDebugReportObjectTypeEXT, ulong, nuint, int, byte*, byte*, void>)GetVkFunction(
