...
/// <summary>
///     VK_EXT_swapchain_colorspace - instance extension (nr. 105) - author 'GOOGLE' [platform '' | contact 'Courtney Goeltzenleuchter @courtney-g']
///     <br />
...
public static class VkExtSwapchainColorspace
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_SWAPCHAIN_COLOR_SPACE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
