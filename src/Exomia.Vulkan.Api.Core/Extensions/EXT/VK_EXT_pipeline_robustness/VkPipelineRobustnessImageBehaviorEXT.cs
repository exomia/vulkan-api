...
public enum VkPipelineRobustnessImageBehaviorEXT
{
    ...
    /// <summary>
    ///     VK_PIPELINE_ROBUSTNESS_IMAGE_BEHAVIOR_DISABLED_EXT specifies that image accesses by this pipeline stage to the
    ///     relevant resource types must not be out of bounds
    /// </summary>
