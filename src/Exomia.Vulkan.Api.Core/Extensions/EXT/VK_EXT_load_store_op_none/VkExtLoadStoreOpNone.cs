...
/// <summary>
///     VK_EXT_load_store_op_none - device extension (nr. 401) - author 'EXT' [platform '' | contact 'Shahbaz Youssefi @syoussefi']
///     <br />
...
public static class VkExtLoadStoreOpNone
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_LOAD_STORE_OP_NONE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
