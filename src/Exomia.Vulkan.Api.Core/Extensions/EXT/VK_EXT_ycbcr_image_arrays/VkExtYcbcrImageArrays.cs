...
/// <summary>
///     VK_EXT_ycbcr_image_arrays - device extension (nr. 253) - author 'EXT' [platform '' | contact 'Piers Daniell @pdaniell-nv']
///     <br />
...
public static class VkExtYcbcrImageArrays
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
