...
public unsafe struct VkDrmFormatModifierPropertiesList2EXT
{
    ...
    /// <summary> drmFormatModifierCount is an inout parameter related to the number of modifiers compatible with the format, as described below. </summary>
    public uint drmFormatModifierCount;

    /// <summary> pDrmFormatModifierProperties is either NULL or a pointer to an array of VkDrmFormatModifierProperties2EXT structures. </summary>
