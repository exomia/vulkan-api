...
public struct VkDrmFormatModifierProperties2EXT
{
    ...
    /// <summary> drmFormatModifierTilingFeatures is a bitmask of VkFormatFeatureFlagBits2 that are supported by any image created with format and drmFormatModifier. </summary>
