...
/// <summary>
///     VK_EXT_image_view_min_lod - device extension (nr. 392) - author 'EXT' [platform '' | contact 'Joshua Ashton @Joshua-Ashton']
///     <br />
...
public static class VkExtImageViewMinLod
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_IMAGE_VIEW_MIN_LOD_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
