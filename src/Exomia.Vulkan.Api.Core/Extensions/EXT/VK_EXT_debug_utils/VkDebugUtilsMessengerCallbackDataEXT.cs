...
public unsafe struct VkDebugUtilsMessengerCallbackDataEXT
{
    ...
    /// <summary> pMessageIdName is a null-terminated string that identifies the particular message ID that is associated with the provided message. If the message corresponds to a validation layer message, then this string may contain the portion of the Vulkan specification that is believed to have been violated. </summary>
    public byte* pMessageIdName;

    /// <summary> messageIdNumber is the ID number of the triggering message. If the message corresponds to a validation layer message, then this number is related to the internal number associated with the message being triggered. </summary>
    ...
    /// <summary> pQueueLabels is NULL or a pointer to an array of VkDebugUtilsLabelEXT active in the current VkQueue at the time the callback was triggered. Refer to Queue Labels for more information. </summary>
    public VkDebugUtilsLabelEXT* pQueueLabels;

    /// <summary> cmdBufLabelCount is a count of items contained in the pCmdBufLabels array. </summary>
    public uint cmdBufLabelCount;

    /// <summary> pCmdBufLabels is NULL or a pointer to an array of VkDebugUtilsLabelEXT active in the current VkCommandBufferat the time the callback was triggered. Refer to Command Buffer Labels for more information. </summary>
    public VkDebugUtilsLabelEXT* pCmdBufLabels;

    /// <summary> objectCount is a count of items contained in the pObjectsarray. </summary>
    public uint objectCount;

    /// <summary> pObjects is a pointer to an array of VkDebugUtilsObjectNameInfoEXT objects related to the detected issue. The array is roughly in order or importance, but the 0th element is always guaranteed to be the most important object for this message. </summary>
