...
/// <summary>
///     VK_EXT_robustness2 - device extension (nr. 287) - author 'EXT' [platform '' | contact 'Liam Middlebrook @liam-middlebrook']
///     <br />
...
public static class VkExtRobustness2
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_ROBUSTNESS_2_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
