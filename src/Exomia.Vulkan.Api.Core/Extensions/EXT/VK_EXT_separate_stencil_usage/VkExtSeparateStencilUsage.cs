...
/// <summary>
///     VK_EXT_separate_stencil_usage - device extension (nr. 247) - author 'EXT' [platform '' | contact 'Daniel Rakos
///     @drakos-amd']<br />
...
public static class VkExtSeparateStencilUsage
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_EXT_SEPARATE_STENCIL_USAGE_EXTENSION_NAME" /> represented by
    ///     an UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
