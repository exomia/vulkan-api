...
{
    /// <summary>
    ///     VK_IMAGE_COMPRESSION_DEFAULT_EXT specifies that the default image compression setting is used. Implementations
    ///     must not apply fixed-rate compression.
    /// </summary>
    VK_IMAGE_COMPRESSION_DEFAULT_EXT = 0,

    /// <summary>
    ///     VK_IMAGE_COMPRESSION_FIXED_RATE_DEFAULT_EXT specifies that the implementation may choose any supported
    ///     fixed-rate compression setting in an implementation-defined manner based on the properties of the image.
    /// </summary>
    VK_IMAGE_COMPRESSION_FIXED_RATE_DEFAULT_EXT = 0x1,

    /// <summary>
    ///     VK_IMAGE_COMPRESSION_FIXED_RATE_EXPLICIT_EXT specifies that fixed-rate compression may be used and that the
    ///     allowed compression rates are specified by
