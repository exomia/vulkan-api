...
/// <summary>
///     VK_EXT_4444_formats - device extension (nr. 341) - author 'EXT' [platform '' | contact 'Joshua Ashton @Joshua-Ashton']
///     <br />
...
public static class VkExt4444Formats
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_4444_FORMATS_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
