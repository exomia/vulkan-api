...
/// <summary>
///     VK_EXT_index_type_uint8 - device extension (nr. 266) - author 'EXT' [platform '' | contact 'Piers Daniell @pdaniell-nv']
///     <br />
...
public static class VkExtIndexTypeUint8
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_INDEX_TYPE_UINT8_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
