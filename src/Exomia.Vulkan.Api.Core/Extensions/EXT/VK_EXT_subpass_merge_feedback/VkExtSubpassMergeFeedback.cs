...
/// <summary>
///     VK_EXT_subpass_merge_feedback - device extension (nr. 459) - author 'EXT' [platform '' | contact 'Ting Wei @catweiting']
///     <br />
...
public static class VkExtSubpassMergeFeedback
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_SUBPASS_MERGE_FEEDBACK_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
