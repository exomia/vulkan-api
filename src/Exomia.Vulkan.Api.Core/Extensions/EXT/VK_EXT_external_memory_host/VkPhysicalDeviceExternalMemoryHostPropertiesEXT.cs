...
public unsafe struct VkPhysicalDeviceExternalMemoryHostPropertiesEXT
{
    ...
    /// <summary> minImportedHostPointerAlignment is the minimum requiredalignment, in bytes, for the base address and size of host pointers that can be imported to a Vulkan memory object. The value must be a power of two. </summary>
