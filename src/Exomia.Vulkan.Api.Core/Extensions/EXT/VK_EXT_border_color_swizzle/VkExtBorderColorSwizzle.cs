...
/// <summary>
///     VK_EXT_border_color_swizzle - device extension (nr. 412) - author 'EXT' [platform '' | contact 'Piers Daniell @pdaniell-nv']
///     <br />
...
/// </remarks>
[VkRequires("VK_EXT_custom_border_color")]
...
public static class VkExtBorderColorSwizzle
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_BORDER_COLOR_SWIZZLE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
