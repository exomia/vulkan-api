...
/// <summary>
///     VK_EXT_mesh_shader - device extension (nr. 329) - author 'EXT' [platform '' | contact 'Christoph Kubisch @pixeljetstream']
///     <br />
...
public static unsafe class VkExtMeshShader
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_EXT_MESH_SHADER_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
