...
/// <summary>
///     VK_QCOM_image_processing - device extension (nr. 441) - author 'QCOM' [platform '' | contact 'Jeff Leger @jackohound']
///     <br />
...
/// </summary>
[VkRequires("VK_KHR_format_feature_flags2")]
public static class VkQcomImageProcessing
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_QCOM_IMAGE_PROCESSING_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br />
    ///     <br />
