...
{
    /// <summary>The VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_API_VERSION_1_0_0.</summary>
    public const uint VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_API_VERSION_1_0_0 = (1 << 22) | (0 << 12) | 0;
}