...
public static partial class Vk
{
    ...
    /// </summary>
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkInstanceCreateInfo structure controlling creation of the instance. </param>
    ...
    /// <param name="pPhysicalDeviceCount"> pPhysicalDeviceCount is a pointer to an integer related to the number of physical devices available or queried, as described below. </param>
    ...
    /// <param name="pFeatures"> pFeatures is a pointer to a VkPhysicalDeviceFeaturesstructure in which the physical device features are returned. For each feature, a value of VK_TRUE specifies that the feature is supported on this physical device, and VK_FALSE specifies that the feature is not supported. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pFormatProperties"> pFormatProperties is a pointer to a VkFormatPropertiesstructure in which physical device properties for format are returned. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="format"> format is a VkFormat value specifying the image format, corresponding to VkImageCreateInfo::format. </param>
    /// <param name="type"> type is a VkImageType value specifying the image type, corresponding to VkImageCreateInfo::imageType. </param>
    /// <param name="tiling"> tiling is a VkImageTiling value specifying the image tiling, corresponding to VkImageCreateInfo::tiling. </param>
    /// <param name="usage"> usage is a bitmask of VkImageUsageFlagBits specifying the intended usage of the image, corresponding to VkImageCreateInfo::usage. </param>
    /// <param name="flags"> flags is a bitmask of VkImageCreateFlagBits specifying additional parameters of the image, corresponding to VkImageCreateInfo::flags. </param>
    /// <param name="pImageFormatProperties"> pImageFormatProperties is a pointer to a VkImageFormatProperties structure in which capabilities are returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pProperties"> pProperties is a pointer to a VkPhysicalDevicePropertiesstructure in which properties are returned. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// </summary>
    /// <param name="physicalDevice"> physicalDevice is the handle to the physical device whose properties will be queried. </param>
    /// <param name="pQueueFamilyPropertyCount"> pQueueFamilyPropertyCount is a pointer to an integer related to the number of queue families available or queried, as described below. </param>
    /// <param name="pQueueFamilyProperties"> pQueueFamilyProperties is either NULL or a pointer to an array of VkQueueFamilyProperties structures. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pMemoryProperties"> pMemoryProperties is a pointer to a VkPhysicalDeviceMemoryProperties structure in which the properties are returned. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// </summary>
    /// <param name="instance"> instance is the instance that the function pointer will be compatible with, or NULL for commands not dependent on any instance. </param>
    ...
    /// </summary>
    /// <param name="physicalDevice"> physicalDevice must be one of the device handles returned from a call to vkEnumeratePhysicalDevices (see Physical Device Enumeration). </param>
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkDeviceCreateInfo structure containing information about how to create the device. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    ///     </a>
    /// </summary>
    /// <param name="pLayerName"> pLayerName is either NULL or a pointer to a null-terminated UTF-8 string naming the layer to retrieve extensions from. </param>
    /// <param name="pPropertyCount"> pPropertyCount is a pointer to an integer related to the number of extension properties available or queried, as described below. </param>
    ...
    /// <param name="pLayerName"> pLayerName is either NULL or a pointer to a null-terminated UTF-8 string naming the layer to retrieve extensions from. </param>
    /// <param name="pPropertyCount"> pPropertyCount is a pointer to an integer related to the number of extension properties available or queried, and is treated in the same fashion as the vkEnumerateInstanceExtensionProperties::pPropertyCountparameter. </param>
    /// <param name="pProperties"> pProperties is either NULL or a pointer to an array of VkExtensionProperties structures. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    ///     </a>
    /// </summary>
    /// <param name="pPropertyCount"> pPropertyCount is a pointer to an integer related to the number of layer properties available or queried, as described below. </param>
    ...
    /// </summary>
    /// <param name="physicalDevice"> physicalDevice is the physical device that will be queried. </param>
    /// <param name="pPropertyCount"> pPropertyCount is a pointer to an integer related to the number of layer properties available or queried. </param>
    /// <param name="pProperties"> pProperties is either NULL or a pointer to an array of VkLayerProperties structures. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    /// <param name="pQueue"> pQueue is a pointer to a VkQueue object that will be filled with the handle for the requested queue. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pSubmits"> pSubmits is a pointer to an array of VkSubmitInfostructures, each specifying a command buffer submission batch. </param>
    ...
    /// <param name="pAllocateInfo"> pAllocateInfo is a pointer to a VkMemoryAllocateInfostructure describing parameters of the allocation. A successfully returned allocation must use the requested parameters&#8201;&#8212;&#8201;no substitution is permitted by the implementation. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pMemory"> pMemory is a pointer to a VkDeviceMemory handle in which information about the allocated memory is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="size"> size is the size of the memory range to map, or VK_WHOLE_SIZE to map from offset to the end of the allocation. </param>
    /// <param name="flags"> flags is reserved for future use. </param>
    /// <param name="ppData"> ppData is a pointer to a void* variable in which a host-accessible pointer to the beginning of the mapped range is returned. This pointer minus offset must be aligned to at least VkPhysicalDeviceLimits::minMemoryMapAlignment. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pMemoryRanges"> pMemoryRanges is a pointer to an array of VkMappedMemoryRange structures describing the memory ranges to flush. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="device"> device is the logical device that owns the memory ranges. </param>
    /// <param name="memoryRangeCount"> memoryRangeCount is the length of the pMemoryRanges array. </param>
    /// <param name="pMemoryRanges"> pMemoryRanges is a pointer to an array of VkMappedMemoryRange structures describing the memory ranges to invalidate. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCommittedMemoryInBytes"> pCommittedMemoryInBytes is a pointer to a VkDeviceSizevalue in which the number of bytes currently committed is returned, on success. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="memoryOffset"> memoryOffset is the start offset of the region of memorywhich is to be bound to the buffer. The number of bytes returned in the VkMemoryRequirements::size member in memory, starting from memoryOffset bytes, will be bound to the specified buffer. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="memoryOffset"> memoryOffset is the start offset of the region of memorywhich is to be bound to the image. The number of bytes returned in the VkMemoryRequirements::size member in memory, starting from memoryOffset bytes, will be bound to the specified image. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pMemoryRequirements"> pMemoryRequirements is a pointer to a VkMemoryRequirementsstructure in which the memory requirements of the buffer object are returned. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pMemoryRequirements"> pMemoryRequirements is a pointer to a VkMemoryRequirementsstructure in which the memory requirements of the image object are returned. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pSparseMemoryRequirements"> pSparseMemoryRequirements is either NULL or a pointer to an array of VkSparseImageMemoryRequirements structures. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    ///     </a>
    /// </summary>
    /// <param name="physicalDevice"> physicalDevice is the physical device from which to query the sparse image format properties. </param>
    ...
    /// <param name="pPropertyCount"> pPropertyCount is a pointer to an integer related to the number of sparse format properties available or queried, as described below. </param>
    /// <param name="pProperties"> pProperties is either NULL or a pointer to an array of VkSparseImageFormatProperties structures. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pBindInfo"> pBindInfo is a pointer to an array of VkBindSparseInfostructures, each specifying a sparse binding submission batch. </param>
    /// <param name="fence"> fence is an optional handle to a fence to be signaled. If fence is not VK_NULL_HANDLE, it defines a fence signal operation. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkFenceCreateInfo structure containing information about how the fence is to be created. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="waitAll"> waitAll is the condition that must be satisfied to successfully unblock the wait. If waitAll is VK_TRUE, then the condition is that all fences in pFences are signaled. Otherwise, the condition is that at least one fence in pFences is signaled. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkSemaphoreCreateInfostructure containing information about how the semaphore is to be created. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkEventCreateInfo structure containing information about how the event is to be created. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkQueryPoolCreateInfostructure containing the number and type of queries to be managed by the pool. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pQueryPool"> pQueryPool is a pointer to a VkQueryPool handle in which the resulting query pool object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkBufferCreateInfo structure containing parameters affecting creation of the buffer. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkBufferViewCreateInfostructure containing parameters to be used to create the buffer view. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkImageCreateInfo structure containing parameters to be used to create the image. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pSubresource"> pSubresource is a pointer to a VkImageSubresource structure selecting a specific image subresource from the image. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkImageViewCreateInfostructure containing parameters to be used to create the image view. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pShaderModule"> pShaderModule is a pointer to a VkShaderModule handle in which the resulting shader module object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkPipelineCacheCreateInfostructure containing initial parameters for the pipeline cache object. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pPipelineCache"> pPipelineCache is a pointer to a VkPipelineCache handle in which the resulting pipeline cache object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pDataSize"> pDataSize is a pointer to a size_t value related to the amount of data in the pipeline cache, as described below. </param>
    ...
    /// <param name="pSrcCaches"> pSrcCaches is a pointer to an array of pipeline cache handles, which will be merged into dstCache. The previous contents of dstCache are included after the merge. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pPipelines"> pPipelines is a pointer to an array of VkPipeline handles in which the resulting graphics pipeline objects are returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pPipelines"> pPipelines is a pointer to an array of VkPipeline handles in which the resulting compute pipeline objects are returned.editing-noteTODO (Jon) - Should we say something like &#8220;the i&#8217;th element of the pPipelines array is created based on the corresponding element of the pCreateInfos array&#8221;? Also for vkCreateGraphicsPipelines below. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS,VK_PIPELINE_COMPILE_REQUIRED_EXT </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkPipelineLayoutCreateInfostructure specifying the state of the pipeline layout object. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pPipelineLayout"> pPipelineLayout is a pointer to a VkPipelineLayout handle in which the resulting pipeline layout object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkSamplerCreateInfo structure specifying the state of the sampler object. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkDescriptorSetLayoutCreateInfo structure specifying the state of the descriptor set layout object. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pSetLayout"> pSetLayout is a pointer to a VkDescriptorSetLayout handle in which the resulting descriptor set layout object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkDescriptorPoolCreateInfostructure specifying the state of the descriptor pool object. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pDescriptorPool"> pDescriptorPool is a pointer to a VkDescriptorPool handle in which the resulting descriptor pool object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// </summary>
    /// <param name="device"> device is the logical device that owns the descriptor pool. </param>
    /// <param name="pAllocateInfo"> pAllocateInfo is a pointer to a VkDescriptorSetAllocateInfostructure describing parameters of the allocation. </param>
    /// <param name="pDescriptorSets"> pDescriptorSets is a pointer to an array of VkDescriptorSethandles in which the resulting descriptor set objects are returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pDescriptorWrites"> pDescriptorWrites is a pointer to an array of VkWriteDescriptorSet structures describing the descriptor sets to write to. </param>
    /// <param name="descriptorCopyCount"> descriptorCopyCount is the number of elements in the pDescriptorCopies array. </param>
    /// <param name="pDescriptorCopies"> pDescriptorCopies is a pointer to an array of VkCopyDescriptorSet structures describing the descriptor sets to copy between. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkFramebufferCreateInfostructure describing additional information about framebuffer creation. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pFramebuffer"> pFramebuffer is a pointer to a VkFramebuffer handle in which the resulting framebuffer object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkRenderPassCreateInfostructure describing the parameters of the render pass. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkCommandPoolCreateInfostructure specifying the state of the command pool object. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    ...
    /// </summary>
    /// <param name="device"> device is the logical device that owns the command pool. </param>
    /// <param name="pAllocateInfo"> pAllocateInfo is a pointer to a VkCommandBufferAllocateInfostructure describing parameters of the allocation. </param>
    /// <param name="pCommandBuffers"> pCommandBuffers is a pointer to an array of VkCommandBufferhandles in which the resulting command buffer objects are returned. The array must be at least the length specified by the commandBufferCount member of pAllocateInfo. Each allocated command buffer begins in the initial state. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the handle of the command buffer which is to be put in the recording state. </param>
    /// <param name="pBeginInfo"> pBeginInfo is a pointer to a VkCommandBufferBeginInfostructure defining additional information about how the command buffer begins recording. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer to reset. The command buffer can be in any state other than pending, and is moved into the initial state. </param>
    ...
    /// <param name="pipelineBindPoint"> pipelineBindPoint is a VkPipelineBindPoint value specifying to which bind point the pipeline is bound. Binding one does not disturb the others. </param>
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="depthBiasConstantFactor"> depthBiasConstantFactor is a scalar factor controlling the constant depth value added to each fragment. </param>
    /// <param name="depthBiasClamp"> depthBiasClamp is the maximum (or minimum) depth bias of a fragment. </param>
    /// <param name="depthBiasSlopeFactor"> depthBiasSlopeFactor is a scalar factor applied to a fragment&#8217;s slope in depth bias calculations. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="blendConstants"> blendConstants is a pointer to an array of four values specifying the Rc, Gc, Bc, and Ac components of the blend constant color used in blending, depending on the blend factor. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="faceMask"> faceMask is a bitmask of VkStencilFaceFlagBits specifying the set of stencil state for which to update the compare mask. </param>
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="faceMask"> faceMask is a bitmask of VkStencilFaceFlagBits specifying the set of stencil state for which to update the write mask, as described above for vkCmdSetStencilCompareMask. </param>
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="faceMask"> faceMask is a bitmask of VkStencilFaceFlagBits specifying the set of stencil state for which to update the reference value, as described above for vkCmdSetStencilCompareMask. </param>
    ...
    /// <param name="pipelineBindPoint"> pipelineBindPoint is a VkPipelineBindPoint indicating the type of the pipeline that will use the descriptors. There is a separate set of bind points for each pipeline type, so binding one does not disturb the others. </param>
    ...
    /// <param name="descriptorSetCount"> descriptorSetCount is the number of elements in the pDescriptorSets array. </param>
    /// <param name="pDescriptorSets"> pDescriptorSets is a pointer to an array of handles to VkDescriptorSet objects describing the descriptor sets to bind to. </param>
    ...
    /// <param name="pData"> pData is a pointer to the source data for the buffer update, and must be at least dataSize bytes in size. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="dstOffset"> dstOffset is the byte offset into the buffer at which to start filling, and must be a multiple of 4. </param>
    /// <param name="size"> size is the number of bytes to fill, and must be either a multiple of 4, or VK_WHOLE_SIZE to fill the range from offset to the end of the buffer. If VK_WHOLE_SIZE is used and the remaining size of the buffer is not a multiple of 4, then the nearest smaller multiple is used. </param>
    /// <param name="data"> data is the 4-byte word written repeatedly to the buffer to fill size bytes of data. The data word is written to memory according to the host endianness. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="imageLayout"> imageLayout specifies the current layout of the image subresource ranges to be cleared, and must be VK_IMAGE_LAYOUT_SHARED_PRESENT_KHR, VK_IMAGE_LAYOUT_GENERAL or VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL. </param>
    /// <param name="pColor"> pColor is a pointer to a VkClearColorValue structure containing the values that the image subresource ranges will be cleared to (see https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#clears-values below). </param>
    /// <param name="rangeCount"> rangeCount is the number of image subresource range structures in pRanges. </param>
    /// <param name="pRanges"> pRanges is a pointer to an array of VkImageSubresourceRangestructures describing a range of mipmap levels, array layers, and aspects to be cleared, as described in Image Views. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="commandBuffer"> commandBuffer is the command buffer into which the command will be recorded. </param>
    /// <param name="image"> image is the image to be cleared. </param>
    /// <param name="imageLayout"> imageLayout specifies the current layout of the image subresource ranges to be cleared, and must be VK_IMAGE_LAYOUT_GENERAL or VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL. </param>
    /// <param name="pDepthStencil"> pDepthStencil is a pointer to a VkClearDepthStencilValuestructure containing the values that the depth and stencil image subresource ranges will be cleared to (see https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#clears-values below). </param>
    /// <param name="rangeCount"> rangeCount is the number of image subresource range structures in pRanges. </param>
    /// <param name="pRanges"> pRanges is a pointer to an array of VkImageSubresourceRangestructures describing a range of mipmap levels, array layers, and aspects to be cleared, as described in Image Views. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pAttachments"> pAttachments is a pointer to an array of VkClearAttachmentstructures defining the attachments to clear and the clear values to use. </param>
    /// <param name="rectCount"> rectCount is the number of entries in the pRects array. </param>
    /// <param name="pRects"> pRects is a pointer to an array of VkClearRect structures defining regions within each selected attachment to clear. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="stageMask"> stageMask is a bitmask of VkPipelineStageFlagBits specifying the source stage mask used to determine when the event is unsignaled. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="dependencyFlags"> dependencyFlags is a bitmask of VkDependencyFlagBitsspecifying how execution and memory dependencies are formed. </param>
    /// <param name="memoryBarrierCount"> memoryBarrierCount is the length of the pMemoryBarriersarray. </param>
    /// <param name="pMemoryBarriers"> pMemoryBarriers is a pointer to an array of VkMemoryBarrierstructures. </param>
    /// <param name="bufferMemoryBarrierCount"> bufferMemoryBarrierCount is the length of the pBufferMemoryBarriers array. </param>
    /// <param name="pBufferMemoryBarriers"> pBufferMemoryBarriers is a pointer to an array of VkBufferMemoryBarrier structures. </param>
    ...
    /// <param name="flags"> flags is a bitmask of VkQueryControlFlagBits specifying constraints on the types of queries that can be performed. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="queryPool"> queryPool is the query pool managing the queries containing the desired results. </param>
    /// <param name="firstQuery"> firstQuery is the initial query index. </param>
    /// <param name="queryCount"> queryCount is the number of queries. firstQuery and queryCount together define a range of queries. </param>
    ...
    /// <param name="stride"> stride is the stride in bytes between results for individual queries within dstBuffer. The required size of the backing memory for dstBuffer is determined as described above for vkGetQueryPoolResults. </param>
    /// <param name="flags"> flags is a bitmask of VkQueryResultFlagBits specifying how and when results are returned. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="stageFlags"> stageFlags is a bitmask of VkShaderStageFlagBits specifying the shader stages that will use the push constants in the updated range. </param>
    ...
    /// <param name="contents"> contents is a VkSubpassContents value specifying how the commands in the first subpass will be provided. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is the command buffer in which to record the command. </param>
    /// <param name="contents"> contents specifies how the commands in the next subpass will be provided, in the same fashion as the corresponding parameter of vkCmdBeginRenderPass. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// </summary>
    /// <param name="commandBuffer"> commandBuffer is a handle to a primary command buffer that the secondary command buffers are executed in. </param>
    /// <param name="commandBufferCount"> commandBufferCount is the length of the pCommandBuffersarray. </param>
    /// <param name="pCommandBuffers"> pCommandBuffers is a pointer to an array of commandBufferCount secondary command buffer handles, which are recorded to execute in the primary command buffer in the order they are listed in the array. </param>
    [VkVersion("1.0")]
    [SuppressUnmanagedCodeSecurity]
