...
public unsafe struct VkClearColorValue
{
    ...
    ///     https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#formats-numericformat table other
    ///     than signed integer (SINT) or unsigned integer (UINT). Floating point values are automatically converted to the
