...
public struct VkStencilOpState
{
    ...
    /// <summary> passOp is a VkStencilOp value specifying the action performed on samples that pass both the depth and stencil tests. </summary>
    public VkStencilOp passOp;

    /// <summary> depthFailOp is a VkStencilOp value specifying the action performed on samples that pass the stencil test and fail the depth test. </summary>
    ...
    /// <summary> writeMask selects the bits of the unsigned integer stencil values updated by the stencil test in the stencil framebuffer attachment. </summary>
