...
public unsafe struct VkShaderModuleCreateInfo
{
    ...
    /// <summary> pCode is a pointer to code that is used to create the shader module. The type and format of the code is determined from the content of the memory addressed by pCode. </summary>
    public uint* pCode;
}