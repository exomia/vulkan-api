...
public unsafe struct VkPhysicalDeviceVulkan11Features
{
    ...
    /// <summary> variablePointersStorageBuffer specifies whether the implementation supports the SPIR-V VariablePointersStorageBuffer capability. When this feature is not enabled, shader modules must not declare the SPV_KHR_variable_pointers extension or the VariablePointersStorageBuffer capability. </summary>
    public VkBool32 variablePointersStorageBuffer;

    /// <summary> variablePointersspecifies whether the implementation supports the SPIR-V VariablePointers capability. When this feature is not enabled, shader modules must not declare the VariablePointers capability. </summary>
    public VkBool32 variablePointers;

    /// <summary> protectedMemoryspecifies whether protected memory is supported. </summary>
    public VkBool32 protectedMemory;

    /// <summary> samplerYcbcrConversion specifies whether the implementation supports sampler Y′CBCR conversion. If samplerYcbcrConversion is VK_FALSE, sampler Y′CBCRconversion is not supported, and samplers using sampler Y′CBCRconversion must not be used. </summary>
    public VkBool32 samplerYcbcrConversion;

    /// <summary> shaderDrawParameters specifies whether the implementation supports the SPIR-V DrawParameters capability. When this feature is not enabled, shader modules must not declare the SPV_KHR_shader_draw_parameters extension or the DrawParameterscapability. </summary>
