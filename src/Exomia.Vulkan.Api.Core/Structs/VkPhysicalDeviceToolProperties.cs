...
public unsafe struct VkPhysicalDeviceToolProperties
{
    ...
    /// <summary> layer is a null-terminated UTF-8 string containing the name of the layer implementing the tool, if the tool is implemented in a layer - otherwise it may be an empty string. </summary>
