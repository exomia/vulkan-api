...
/// <summary>
///     VkMemoryDedicatedRequirements - Structure describing dedicated allocation requirements of buffer and image
///     resources -
...
public unsafe struct VkMemoryDedicatedRequirements
{
    ...
    /// <summary>
    ///     prefersDedicatedAllocation specifies that the implementation would prefer a dedicated allocation for this
    ///     resource. The application is still free to suballocate the resource but it mayget better performance if a dedicated
    ///     allocation is used.
    /// </summary>
