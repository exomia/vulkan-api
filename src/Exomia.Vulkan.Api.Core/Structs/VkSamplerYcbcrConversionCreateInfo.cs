...
public unsafe struct VkSamplerYcbcrConversionCreateInfo
{
    ...
    /// <summary>
    ///     ycbcrRange describes whether the encoded values have headroom and foot room, or whether the encoding uses the
    ///     full numerical range.
    /// </summary>
    public VkSamplerYcbcrRange ycbcrRange;

    /// <summary>
    ///     components applies a swizzle based on VkComponentSwizzleenums prior to range expansion and color model
    ///     conversion.
    /// </summary>
    public VkComponentMapping components;

    /// <summary>
    ///     xChromaOffset describes the sample location associated with downsampled chroma components in the x dimension.
    ///     xChromaOffset has no effect for formats in which chroma components are not downsampled horizontally.
    /// </summary>
    public VkChromaLocation xChromaOffset;

    /// <summary>
    ///     yChromaOffset describes the sample location associated with downsampled chroma components in the y dimension.
    ///     yChromaOffset has no effect for formats in which the chroma components are not downsampled vertically.
    /// </summary>
