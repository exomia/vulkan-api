...
public unsafe struct VkImageViewCreateInfo
{
    ...
    /// <summary> components is a VkComponentMapping structure specifying a remapping of color components (or of depth or stencil components after they have been converted into color components). </summary>
    public VkComponentMapping components;

    /// <summary> subresourceRange is a VkImageSubresourceRange structure selecting the set of mipmap levels and array layers to be accessible to the view. </summary>
