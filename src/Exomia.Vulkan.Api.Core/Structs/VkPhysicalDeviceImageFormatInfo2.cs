...
public unsafe struct VkPhysicalDeviceImageFormatInfo2
{
    ...
    /// <summary> pNext is NULL or a pointer to a structure extending this structure. The pNext chain of VkPhysicalDeviceImageFormatInfo2 is used to provide additional image parameters to vkGetPhysicalDeviceImageFormatProperties2. </summary>
    public void* pNext;
    ...
    /// <summary> usage is a bitmask of VkImageUsageFlagBits indicating the intended usage of the image, corresponding to VkImageCreateInfo::usage. </summary>
    public VkImageUsageFlags usage;

    /// <summary> flags is a bitmask of VkImageCreateFlagBits indicating additional parameters of the image, corresponding to VkImageCreateInfo::flags. </summary>
