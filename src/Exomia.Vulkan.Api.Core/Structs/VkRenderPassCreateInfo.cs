...
public unsafe struct VkRenderPassCreateInfo
{
    ...
    /// <summary> pAttachments is a pointer to an array of attachmentCountVkAttachmentDescription structures describing the attachments used by the render pass. </summary>
    ...
    /// <summary> pDependencies is a pointer to an array of dependencyCountVkSubpassDependency structures describing dependencies between pairs of subpasses. </summary>
