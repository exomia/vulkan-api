...
public unsafe struct VkPhysicalDeviceExternalImageFormatInfo
{
    ...
    /// <summary> handleType is a VkExternalMemoryHandleTypeFlagBits value specifying the memory handle type that will be used with the memory associated with the image. </summary>
