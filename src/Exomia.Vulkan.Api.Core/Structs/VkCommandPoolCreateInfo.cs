...
public unsafe struct VkCommandPoolCreateInfo
{
    ...
    /// <summary>
    ///     flags is a bitmask of VkCommandPoolCreateFlagBits indicating usage behavior for the pool and command buffers
    ///     allocated from it.
    /// </summary>
    ...
    ///     buffers allocated from this command pool must be submitted on queues from the same queue family.
    /// </summary>
