...
public unsafe struct VkAttachmentDescriptionStencilLayout
{
    ...
    /// <summary> stencilInitialLayout is the layout the stencil aspect of the attachment image subresource will be in when a render pass instance begins. </summary>
    public VkImageLayout stencilInitialLayout;

    /// <summary> stencilFinalLayout is the layout the stencil aspect of the attachment image subresource will be transitioned to when a render pass instance ends. </summary>
