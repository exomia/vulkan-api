...
public unsafe struct VkExportMemoryAllocateInfo
{
    ...
    /// <summary>
    ///     handleTypes is a bitmask of VkExternalMemoryHandleTypeFlagBits specifying one or more memory handle types the
    ///     application can export from the resulting allocation. The application can request multiple handle types for the
    ///     same allocation.
    /// </summary>
