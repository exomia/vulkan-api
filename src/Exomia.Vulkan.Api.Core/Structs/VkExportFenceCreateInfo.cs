...
public unsafe struct VkExportFenceCreateInfo
{
    ...
    /// <summary>
    ///     handleTypes is a bitmask of VkExternalFenceHandleTypeFlagBits specifying one or more fence handle types the
    ///     application can export from the resulting fence. The application can request multiple handle types for the same
    ///     fence.
    /// </summary>
