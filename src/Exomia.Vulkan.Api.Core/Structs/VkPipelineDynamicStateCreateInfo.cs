...
public unsafe struct VkPipelineDynamicStateCreateInfo
{
    ...
    /// <summary>
    ///     pDynamicStates is a pointer to an array of VkDynamicStatevalues specifying which pieces of pipeline state will
    ///     use the values from dynamic state commands rather than from pipeline state creation information.
    /// </summary>
