...
public unsafe struct VkPipelineColorBlendStateCreateInfo
{
    ...
    /// <summary> flags is a bitmask of VkPipelineColorBlendStateCreateFlagBits specifying additional color blending information. </summary>
    ...
    /// <summary> pAttachments is a pointer to an array of VkPipelineColorBlendAttachmentState structures defining blend state for each color attachment. </summary>
    public VkPipelineColorBlendAttachmentState* pAttachments;

    /// <summary> blendConstants is a pointer to an array of four values used as the R, G, B, and A components of the blend constant that are used in blending, depending on the blend factor. </summary>
