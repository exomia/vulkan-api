...
public unsafe struct VkDeviceQueueInfo2
{
    ...
    /// <summary> pNext is NULL or a pointer to a structure extending this structure. The pNext chain of VkDeviceQueueInfo2 can be used to provide additional device queue parameters to vkGetDeviceQueue2. </summary>
    public void* pNext;
    ...
    /// <summary> queueIndex is the index of the queue to retrieve from within the set of queues that share both the queue family and flags specified. </summary>
