...
public unsafe struct VkSubpassDescription2
{
    ...
    /// <summary>
    ///     viewMask is a bitfield of view indices describing which views rendering is broadcast to in this subpass, when
    ...
    /// <summary>
    ///     pInputAttachments is a pointer to an array of VkAttachmentReference2 structures defining the input attachments
    ...
    /// <summary>
    ///     pColorAttachments is a pointer to an array of colorAttachmentCount VkAttachmentReference2 structures defining
    ///     the color attachments for this subpass and their layouts.
    /// </summary>
    public VkAttachmentReference2* pColorAttachments;

    /// <summary>
    ///     pResolveAttachments is NULL or a pointer to an array of colorAttachmentCount VkAttachmentReference2 structures
    ///     defining the resolve attachments for this subpass and their layouts.
    /// </summary>
    public VkAttachmentReference2* pResolveAttachments;

    /// <summary>
    ///     pDepthStencilAttachment is a pointer to a VkAttachmentReference2 structure specifying the depth/stencil
    ...
    /// <summary>
    ///     pPreserveAttachments is a pointer to an array of preserveAttachmentCount render pass attachment indices
    ///     identifying attachments that are not used by this subpass, but whose contents mustbe preserved throughout the
    ///     subpass.
    /// </summary>
