...
public unsafe struct VkPhysicalDeviceProperties2
{
    ...
    /// <summary> properties is a VkPhysicalDeviceProperties structure describing properties of the physical device. This structure is written with the same values as if it were written by vkGetPhysicalDeviceProperties. </summary>
