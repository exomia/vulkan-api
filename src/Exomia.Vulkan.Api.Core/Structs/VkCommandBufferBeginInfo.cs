...
public unsafe struct VkCommandBufferBeginInfo
{
    ...
    /// <summary> pInheritanceInfo is a pointer to a VkCommandBufferInheritanceInfo structure, used if commandBuffer is a secondary command buffer. If this is a primary command buffer, then this value is ignored. </summary>
