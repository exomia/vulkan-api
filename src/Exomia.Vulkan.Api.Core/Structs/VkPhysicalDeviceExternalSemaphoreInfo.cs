...
public unsafe struct VkPhysicalDeviceExternalSemaphoreInfo
{
    ...
    /// <summary> handleType is a VkExternalSemaphoreHandleTypeFlagBits value specifying the external semaphore handle type for which capabilities will be returned. </summary>
