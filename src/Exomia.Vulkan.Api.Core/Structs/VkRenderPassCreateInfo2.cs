...
public unsafe struct VkRenderPassCreateInfo2
{
    ...
    /// <summary> pAttachments is a pointer to an array of attachmentCountVkAttachmentDescription2 structures describing the attachments used by the render pass. </summary>
    ...
    /// <summary> pDependencies is a pointer to an array of dependencyCountVkSubpassDependency2 structures describing dependencies between pairs of subpasses. </summary>
    ...
    /// <summary> pCorrelatedViewMasks is a pointer to an array of view masks indicating sets of views that may be more efficient to render concurrently. </summary>
