...
/// <summary>
///     VkPipelineShaderStageRequiredSubgroupSizeCreateInfo - Structure specifying the required subgroup size of a newly
...
public unsafe struct VkPipelineShaderStageRequiredSubgroupSizeCreateInfo
{
    ...
    /// <summary>
    ///     requiredSubgroupSize is an unsigned integer value specifying the required subgroup size for the newly created
