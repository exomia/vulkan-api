...
public unsafe struct VkPipelineShaderStageCreateInfo
{
    ...
    /// <summary> flags is a bitmask of VkPipelineShaderStageCreateFlagBitsspecifying how the pipeline shader stage will be generated. </summary>
    ...
    /// <summary> pName is a pointer to a null-terminated UTF-8 string specifying the entry point name of the shader for this stage. </summary>
    public byte* pName;

    /// <summary> pSpecializationInfo is a pointer to a VkSpecializationInfostructure, as described in Specialization Constants, or NULL. </summary>
