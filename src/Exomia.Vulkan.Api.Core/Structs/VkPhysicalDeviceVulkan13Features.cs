...
public unsafe struct VkPhysicalDeviceVulkan13Features
{
    ...
    /// <summary> robustImageAccessindicates whether image accesses are tightly bounds-checked against the dimensions of the image view. Invalid texels resulting from out of bounds image loads will be replaced as described in Texel Replacement, with either (0,0,1) or (0,0,0) values inserted for missing G, B, or A components based on the format. </summary>
    ...
    /// <summary> pipelineCreationCacheControl indicates that the implementation supports:The following can be used in Vk*PipelineCreateInfo::flags:VK_PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BITVK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BITThe following can be used in VkPipelineCacheCreateInfo::flags:VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT </summary>
    ...
    /// <summary> shaderTerminateInvocation specifies whether the implementation supports SPIR-V modules that use the SPV_KHR_terminate_invocationextension. </summary>
    ...
    /// <summary> synchronization2indicates whether the implementation supports the new set of synchronization commands introduced in VK_KHR_synchronization2. </summary>
    ...
    /// <summary> shaderZeroInitializeWorkgroupMemory specifies whether the implementation supports initializing a variable in Workgroup storage class. </summary>
    public VkBool32 shaderZeroInitializeWorkgroupMemory;

    /// <summary> dynamicRenderingspecifies that the implementation supports dynamic render pass instances using the vkCmdBeginRendering command. </summary>
