...
public unsafe struct VkSubpassDescription
{
    ...
    /// <summary>
    ///     pInputAttachments is a pointer to an array of VkAttachmentReference structures defining the input attachments
    ...
    /// <summary>
    ///     pColorAttachments is a pointer to an array of colorAttachmentCount VkAttachmentReference structures defining
    ///     the color attachments for this subpass and their layouts.
    /// </summary>
    public VkAttachmentReference* pColorAttachments;

    /// <summary>
    ///     pResolveAttachments is NULL or a pointer to an array of colorAttachmentCount VkAttachmentReference structures
    ///     defining the resolve attachments for this subpass and their layouts.
    /// </summary>
    public VkAttachmentReference* pResolveAttachments;

    /// <summary>
    ///     pDepthStencilAttachment is a pointer to a VkAttachmentReference structure specifying the depth/stencil
