...
public unsafe struct VkCommandBufferSubmitInfo
{
    ...
    /// <summary>
    ///     deviceMask is a bitmask indicating which devices in a device group execute the command buffer. A deviceMask of
    ///     0 is equivalent to setting all bits corresponding to valid devices in the group to 1.
    /// </summary>
