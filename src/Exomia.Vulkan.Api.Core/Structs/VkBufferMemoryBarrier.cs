...
public unsafe struct VkBufferMemoryBarrier
{
    ...
    /// <summary> offset is an offset in bytes into the backing memory for buffer; this is relative to the base offset as bound to the buffer (see vkBindBufferMemory). </summary>
    public VkDeviceSize offset;

    /// <summary> size is a size in bytes of the affected area of backing memory for buffer, or VK_WHOLE_SIZE to use the range from offsetto the end of the buffer. </summary>
