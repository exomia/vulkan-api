...
public unsafe struct VkRenderPassBeginInfo
{
    ...
    /// <summary> renderArea is the render area that is affected by the render pass instance, and is described in more detail below. </summary>
    public VkRect2D renderArea;

    /// <summary> clearValueCount is the number of elements in pClearValues. </summary>
    public uint clearValueCount;

    /// <summary> pClearValues is a pointer to an array of clearValueCountVkClearValue structures containing clear values for each attachment, if the attachment uses a loadOp value of VK_ATTACHMENT_LOAD_OP_CLEAR or if the attachment has a depth/stencil format and uses a stencilLoadOp value of VK_ATTACHMENT_LOAD_OP_CLEAR. The array is indexed by attachment number. Only elements corresponding to cleared attachments are used. Other elements of pClearValues are ignored. </summary>
