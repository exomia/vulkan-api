...
public unsafe struct VkRenderPassAttachmentBeginInfo
{
    ...
    /// <summary> pAttachments is a pointer to an array of VkImageViewhandles, each of which will be used as the corresponding attachment in the render pass instance. </summary>
