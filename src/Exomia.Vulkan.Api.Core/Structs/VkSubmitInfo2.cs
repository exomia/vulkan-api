...
public unsafe struct VkSubmitInfo2
{
    ...
    /// <summary> pWaitSemaphoreInfos is a pointer to an array of VkSemaphoreSubmitInfo structures defining semaphore wait operations. </summary>
    public VkSemaphoreSubmitInfo* pWaitSemaphoreInfos;

    /// <summary> commandBufferInfoCount is the number of elements in pCommandBufferInfos and the number of command buffers to execute in the batch. </summary>
    public uint commandBufferInfoCount;

    /// <summary> pCommandBufferInfos is a pointer to an array of VkCommandBufferSubmitInfo structures describing command buffers to execute in the batch. </summary>
    ...
    /// <summary> pSignalSemaphoreInfos is a pointer to an array of VkSemaphoreSubmitInfo describing semaphore signal operations. </summary>
