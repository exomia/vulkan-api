...
public unsafe struct VkExternalImageFormatProperties
{
    ...
    /// <summary> externalMemoryProperties is a VkExternalMemoryPropertiesstructure specifying various capabilities of the external handle type when used with the specified image creation parameters. </summary>
