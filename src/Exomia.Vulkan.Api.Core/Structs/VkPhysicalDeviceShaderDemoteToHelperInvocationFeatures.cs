...
/// <summary>
///     VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures - Structure describing the shader demote to helper
///     invocations features that can be supported by an implementation -
///     <a
