...
public static partial class Vk
{
    ...
    /// </summary>
    /// <param name="pApiVersion"> pApiVersion is a pointer to a uint32_t, which is the version of Vulkan supported by instance-level functionality, encoded as described in https://registry.khronos.org/vulkan/specs/1.3-extensions/html/vkspec.html#extendingvulkan-coreversions-versionnumbers. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    /// <param name="pBindInfos"> pBindInfos is a pointer to an array of bindInfoCountVkBindBufferMemoryInfo structures describing buffers and memory to bind. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="bindInfoCount"> bindInfoCount is the number of elements in pBindInfos. </param>
    /// <param name="pBindInfos"> pBindInfos is a pointer to an array of VkBindImageMemoryInfostructures, describing images and memory to bind. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="localDeviceIndex"> localDeviceIndex is the device index of the physical device that performs the memory access. </param>
    /// <param name="remoteDeviceIndex"> remoteDeviceIndex is the device index of the physical device that the memory is allocated for. </param>
    /// <param name="pPeerMemoryFeatures"> pPeerMemoryFeatures is a pointer to a VkPeerMemoryFeatureFlags bitmask indicating which types of memory accesses are supported for the combination of heap, local, and remote devices. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pPhysicalDeviceGroupCount"> pPhysicalDeviceGroupCount is a pointer to an integer related to the number of device groups available or queried, as described below. </param>
    /// <param name="pPhysicalDeviceGroupProperties"> pPhysicalDeviceGroupProperties is either NULL or a pointer to an array of VkPhysicalDeviceGroupProperties structures. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ...
    /// <param name="pInfo"> pInfo is a pointer to a VkImageMemoryRequirementsInfo2structure containing parameters required for the memory requirements query. </param>
    ...
    /// <param name="pInfo"> pInfo is a pointer to a VkBufferMemoryRequirementsInfo2structure containing parameters required for the memory requirements query. </param>
    ...
    /// </summary>
    /// <param name="device"> device is the logical device that owns the image. </param>
    /// <param name="pInfo"> pInfo is a pointer to a VkImageSparseMemoryRequirementsInfo2structure containing parameters required for the memory requirements query. </param>
    ...
    /// <param name="pFeatures"> pFeatures is a pointer to a VkPhysicalDeviceFeatures2structure in which the physical device features are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pProperties"> pProperties is a pointer to a VkPhysicalDeviceProperties2structure in which properties are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pFormatProperties"> pFormatProperties is a pointer to a VkFormatProperties2structure in which physical device properties for format are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pImageFormatInfo"> pImageFormatInfo is a pointer to a VkPhysicalDeviceImageFormatInfo2 structure describing the parameters that would be consumed by vkCreateImage. </param>
    /// <param name="pImageFormatProperties"> pImageFormatProperties is a pointer to a VkImageFormatProperties2 structure in which capabilities are returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// </summary>
    /// <param name="physicalDevice"> physicalDevice is the handle to the physical device whose properties will be queried. </param>
    /// <param name="pQueueFamilyPropertyCount"> pQueueFamilyPropertyCount is a pointer to an integer related to the number of queue families available or queried, as described in vkGetPhysicalDeviceQueueFamilyProperties. </param>
    /// <param name="pQueueFamilyProperties"> pQueueFamilyProperties is either NULL or a pointer to an array of VkQueueFamilyProperties2 structures. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pMemoryProperties"> pMemoryProperties is a pointer to a VkPhysicalDeviceMemoryProperties2 structure in which the properties are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pFormatInfo"> pFormatInfo is a pointer to a VkPhysicalDeviceSparseImageFormatInfo2 structure containing input parameters to the command. </param>
    ...
    /// <param name="pProperties"> pProperties is either NULL or a pointer to an array of VkSparseImageFormatProperties2 structures. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pQueueInfo"> pQueueInfo is a pointer to a VkDeviceQueueInfo2 structure, describing parameters of the device queue to be retrieved. </param>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkSamplerYcbcrConversionCreateInfo structure specifying the requested sampler Y′CBCR conversion. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pYcbcrConversion"> pYcbcrConversion is a pointer to a VkSamplerYcbcrConversionhandle in which the resulting sampler Y′CBCR conversion is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="pCreateInfo"> pCreateInfo is a pointer to a VkDescriptorUpdateTemplateCreateInfo structure specifying the set of descriptors to update with a single call to vkCmdPushDescriptorSetWithTemplateKHR or vkUpdateDescriptorSetWithTemplate. </param>
    /// <param name="pAllocator"> pAllocator controls host memory allocation as described in the Memory Allocation chapter. </param>
    /// <param name="pDescriptorUpdateTemplate"> pDescriptorUpdateTemplate is a pointer to a VkDescriptorUpdateTemplate handle in which the resulting descriptor update template object is returned. </param>
    /// <remarks>
    ///     <list type="table">
    ///         <item>
    ///             <term> successcodes </term><description> VK_SUCCESS </description>
    ...
    /// <param name="descriptorUpdateTemplate"> descriptorUpdateTemplate is a VkDescriptorUpdateTemplateobject specifying the update mapping between pData and the descriptor set to update. </param>
    /// <param name="pData"> pData is a pointer to memory containing one or more     VkDescriptorImageInfo, VkDescriptorBufferInfo, or     VkBufferView structures or VkAccelerationStructureKHRor VkAccelerationStructureNVhandles     used to write the descriptors. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pExternalBufferInfo"> pExternalBufferInfo is a pointer to a VkPhysicalDeviceExternalBufferInfo structure describing the parameters that would be consumed by vkCreateBuffer. </param>
    /// <param name="pExternalBufferProperties"> pExternalBufferProperties is a pointer to a VkExternalBufferProperties structure in which capabilities are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pExternalFenceInfo"> pExternalFenceInfo is a pointer to a VkPhysicalDeviceExternalFenceInfo structure describing the parameters that would be consumed by vkCreateFence. </param>
    /// <param name="pExternalFenceProperties"> pExternalFenceProperties is a pointer to a VkExternalFenceProperties structure in which capabilities are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pExternalSemaphoreInfo"> pExternalSemaphoreInfo is a pointer to a VkPhysicalDeviceExternalSemaphoreInfo structure describing the parameters that would be consumed by vkCreateSemaphore. </param>
    /// <param name="pExternalSemaphoreProperties"> pExternalSemaphoreProperties is a pointer to a VkExternalSemaphoreProperties structure in which capabilities are returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
    ...
    /// <param name="pSupport"> pSupport is a pointer to a VkDescriptorSetLayoutSupportstructure, in which information about support for the descriptor set layout object is returned. </param>
    [VkVersion("1.1")]
    [SuppressUnmanagedCodeSecurity]
