...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkSampler is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkSampler to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkSampler. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkSampler to a void*. </summary>
