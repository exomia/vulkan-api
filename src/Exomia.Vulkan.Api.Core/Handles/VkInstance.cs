...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkInstance is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkInstance to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkInstance. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkInstance to a void*. </summary>
