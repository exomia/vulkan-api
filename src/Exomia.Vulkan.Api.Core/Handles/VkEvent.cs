...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkEvent is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkEvent to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkEvent. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkEvent to a void*. </summary>
