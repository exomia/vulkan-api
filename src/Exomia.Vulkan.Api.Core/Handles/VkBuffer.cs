...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkBuffer is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkBuffer to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkBuffer. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkBuffer to a void*. </summary>
