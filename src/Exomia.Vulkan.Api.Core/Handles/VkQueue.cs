...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkQueue is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkQueue to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkQueue. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkQueue to a void*. </summary>
