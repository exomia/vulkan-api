...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkDescriptorPool is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkDescriptorPool to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkDescriptorPool. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkDescriptorPool to a void*. </summary>
