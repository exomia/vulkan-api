...
#pragma warning restore 649
    ...
    /// <summary> Tests if this in VkImageView is considered equal to this instance. </summary>
    /// <param name="obj"> The in VkImageView to compare to this instance. </param>
    ...
    /// <summary> Explicit cast that converts the given void* to a VkImageView. </summary>
    ...
    /// <summary> Explicit cast that converts the given VkImageView to a void*. </summary>
