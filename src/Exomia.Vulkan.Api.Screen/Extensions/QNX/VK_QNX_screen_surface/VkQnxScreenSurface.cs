...
public static unsafe class VkQnxScreenSurface
{
    ...
    public static void Load(VkInstance instance)
    {
        ...
        {
            *pvkCreateScreenSurfaceQNX = (delegate*<VkInstance, VkScreenSurfaceCreateInfoQNX*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)GetVkFunction(
        ...
        {
            *pvkGetPhysicalDeviceScreenPresentationSupportQNX = (delegate*<VkPhysicalDevice, uint, _screen_window*, VkBool32>)GetVkFunction(
