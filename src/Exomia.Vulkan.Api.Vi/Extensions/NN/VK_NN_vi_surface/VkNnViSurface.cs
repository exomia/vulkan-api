...
/// <summary>
///    VK_NN_vi_surface - instance extension (nr. 63) - author 'NN' [platform 'vi' | contact 'Mathias Heyer gitlab:@mheyer']<br/>
...
public static unsafe partial class VkNnViSurface
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_NN_VI_SURFACE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
    ...
    /// <summary> vkCreateViSurfaceNN - Create a slink:VkSurfaceKHR object for a VI layer - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateViSurfaceNN.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateViSurfaceNN.html</a> </summary>
    /// <param name="instance">instance is the instance with which to associate the surface.</param>
    /// <param name="pCreateInfo">pCreateInfo is a pointer to a VkViSurfaceCreateInfoNNstructure containing parameters affecting the creation of the surface object.</param>
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkCreateViSurfaceNN = (delegate*<VkInstance, VkViSurfaceCreateInfoNN*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u7243\u6165\u6574\u6956\u7553\u6672\u6361\u4e65\u004e");
        }
    }
}
