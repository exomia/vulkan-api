...
/// <summary>
///     VK_MVK_macos_surface - instance extension (nr. 124) - author 'MVK' [platform 'macos' | contact 'Bill Hollings @billhollings']
///     <br />
...
public static unsafe class VkMvkMacosSurface
{
    ...
    public static void Load(VkInstance instance)
    {
        ...
        {
            *pvkCreateMacOSSurfaceMVK = (delegate*<VkInstance, VkMacOSSurfaceCreateInfoMVK*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)GetVkFunction(
