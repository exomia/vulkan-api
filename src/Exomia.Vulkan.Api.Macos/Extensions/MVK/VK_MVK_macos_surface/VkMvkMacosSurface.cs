...
/// <summary>
///    VK_MVK_macos_surface - instance extension (nr. 124) - author 'MVK' [platform 'macos' | contact 'Bill Hollings @billhollings']<br/>
...
public static unsafe partial class VkMvkMacosSurface
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_MVK_MACOS_SURFACE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
    ...
    /// <summary> vkCreateMacOSSurfaceMVK - Create a VkSurfaceKHR object for a macOS NSView - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateMacOSSurfaceMVK.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateMacOSSurfaceMVK.html</a> </summary>
    /// <param name="instance">instance is the instance with which to associate the surface.</param>
    /// <param name="pCreateInfo">pCreateInfo is a pointer to a VkMacOSSurfaceCreateInfoMVKstructure containing parameters affecting the creation of the surface object.</param>
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkCreateMacOSSurfaceMVK = (delegate*<VkInstance, VkMacOSSurfaceCreateInfoMVK*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u7243\u6165\u6574\u614d\u4f63\u5353\u7275\u6166\u6563\u564d\u004b");
        }
    }
}
