...
/// <summary>
///     VK_KHR_video_encode_queue - device extension (nr. 300) - author 'KHR' [platform 'provisional' | contact 'Ahmed
...
public static unsafe class VkKhrVideoEncodeQueue
{
    ...
    /// <summary>
    ///     vkCmdEncodeVideoKHR - Encode operation for bitstream generation -
    ...
    ///     commandBuffer is the command buffer to be filled with this function for encoding to
