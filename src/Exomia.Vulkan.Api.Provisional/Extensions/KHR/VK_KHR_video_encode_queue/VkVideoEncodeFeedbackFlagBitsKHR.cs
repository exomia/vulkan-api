...
{
    /// <summary>
    ///     VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_BUFFER_OFFSET_BIT_KHR specifies that queries managed by the pool will
    ///     capture the byte offset of the bitstream data written by the video encode operation to the bitstream buffer
    ///     specified in
    ...
    /// <summary>
    ///     VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_HAS_OVERRIDES_BIT_KHR specifies that queries managed by the pool will
    ///     capture a boolean value indicating that the data written to the bitstream buffer specified in
    ///     <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkVideoEncodeInfoKHR.html">VkVideoEncodeInfoKHR</a>
    ///     ::dstBuffer contains overridden parameters.
    /// </summary>
