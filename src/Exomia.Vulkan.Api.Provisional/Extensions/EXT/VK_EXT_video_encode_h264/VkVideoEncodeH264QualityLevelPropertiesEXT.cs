...
/// <summary>
///     VkVideoEncodeH264QualityLevelPropertiesEXT - Structure describing the H.264 encode quality level properties -
///     <a
///         href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkVideoEncodeH264QualityLevelPropertiesEXT.html">
...
public unsafe struct VkVideoEncodeH264QualityLevelPropertiesEXT
{
    /// <summary> The stype of this structure. </summary>
    public const VkStructureType STYPE = VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUALITY_LEVEL_PROPERTIES_EXT;
    ...
    /// <summary>
    ///     preferredRateControlFlags is a bitmask of VkVideoEncodeH264RateControlFlagBitsEXT values indicating the
    ///     preferred flags to use for VkVideoEncodeH264RateControlInfoEXT::flags.
    /// </summary>
    ...
    ///     VkVideoEncodeH264RateControlInfoEXT::gopFrameCount.
    /// </summary>
    public uint preferredGopFrameCount;

    /// <summary>preferredIdrPeriod indicates the preferred value to use for VkVideoEncodeH264RateControlInfoEXT::idrPeriod.</summary>
    public uint preferredIdrPeriod;

    /// <summary>
    ///     preferredConsecutiveBFrameCount indicates the preferred value to use for
    ///     VkVideoEncodeH264RateControlInfoEXT::consecutiveBFrameCount.
    /// </summary>
    ...
    /// <summary>
    ///     preferredConstantQp indicates the preferred values to use for VkVideoEncodeH264NaluSliceInfoEXT::constantQp
    ///     for each picture type when using rate control mode VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR.
    /// </summary>
