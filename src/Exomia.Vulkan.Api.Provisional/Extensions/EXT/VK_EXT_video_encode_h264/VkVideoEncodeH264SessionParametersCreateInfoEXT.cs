...
/// <summary>
///     VkVideoEncodeH264SessionParametersCreateInfoEXT - Structure specifies H.264 encoder parameter set information -
///     <a
///         href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkVideoEncodeH264SessionParametersCreateInfoEXT.html">
...
public unsafe struct VkVideoEncodeH264SessionParametersCreateInfoEXT
{
    ...
    /// <summary>maxStdSPSCount is the maximum number of SPS parameters that the VkVideoSessionParametersKHR can contain.</summary>
    public uint maxStdSPSCount;

    /// <summary>maxStdPPSCount is the maximum number of PPS parameters that the VkVideoSessionParametersKHR can contain.</summary>
    public uint maxStdPPSCount;

    /// <summary>
    ///     pParametersAddInfo is NULL or a pointer to a VkVideoEncodeH264SessionParametersAddInfoEXT structure specifying
