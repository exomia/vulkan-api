...
/// <summary>
///     VkVideoEncodeH265SessionCreateInfoEXT - Structure specifies H.265 encode session parameters -
///     <a
///         href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VkVideoEncodeH265SessionCreateInfoEXT.html">
...
public unsafe struct VkVideoEncodeH265SessionCreateInfoEXT
{
    ...
    ///     VkVideoEncodeH265CapabilitiesEXT::maxLevelIdc, as reported by vkGetPhysicalDeviceVideoCapabilitiesKHR for the video
    ///     profile.
    /// </summary>
    public VkBool32 useMaxLevelIdc;

    /// <summary>
    ///     maxLevelIdc provides the upper bound on the H.265 level for the video bitstreams produced by the created video
    ///     session.
    /// </summary>
