...
/// <summary>
///    VK_MVK_ios_surface - instance extension (nr. 123) - author 'MVK' [platform 'ios' | contact 'Bill Hollings @billhollings']<br/>
...
public static unsafe partial class VkMvkIosSurface
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_MVK_IOS_SURFACE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
    ...
    /// <summary> vkCreateIOSSurfaceMVK - Create a VkSurfaceKHR object for an iOS UIView - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateIOSSurfaceMVK.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateIOSSurfaceMVK.html</a> </summary>
    /// <param name="instance">instance is the instance with which to associate the surface.</param>
    /// <param name="pCreateInfo">pCreateInfo is a pointer to a VkIOSSurfaceCreateInfoMVKstructure containing parameters affecting the creation of the surface object.</param>
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkCreateIOSSurfaceMVK = (delegate*<VkInstance, VkIOSSurfaceCreateInfoMVK*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u7243\u6165\u6574\u4f49\u5353\u7275\u6166\u6563\u564d\u004b");
        }
    }
}
