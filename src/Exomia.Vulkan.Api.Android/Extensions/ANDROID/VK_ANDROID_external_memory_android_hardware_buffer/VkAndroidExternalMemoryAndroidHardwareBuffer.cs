...
/// <summary>
///    VK_ANDROID_external_memory_android_hardware_buffer - device extension (nr. 130) - author 'ANDROID' [platform 'android' | contact 'Jesse Hall @critsec']<br/>
///    <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VK_ANDROID_external_memory_android_hardware_buffer.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VK_ANDROID_external_memory_android_hardware_buffer.html</a>
/// </summary>
...
public static unsafe partial class VkAndroidExternalMemoryAndroidHardwareBuffer
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_ANDROID_EXTERNAL_MEMORY_ANDROID_HARDWARE_BUFFER_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
    ...
    ///     }
    /// </remarks>
    public const string VK_ANDROID_EXTERNAL_MEMORY_ANDROID_HARDWARE_BUFFER_EXTENSION_NAME_UTF8_NT = "\u4b56\u415f\u444e\u4f52\u4449\u455f\u5458\u5245\u414e\u5f4c\u454d\u4f4d\u5952\u415f\u444e\u4f52\u4449\u485f\u5241\u5744\u5241\u5f45\u5542\u4646\u5245\u455f\u5458\u4e45\u4953\u4e4f\u4e5f\u4d41\u0045";

    /// <summary> vkGetAndroidHardwareBufferPropertiesANDROID - Get Properties of External Memory Android Hardware Buffers - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetAndroidHardwareBufferPropertiesANDROID.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetAndroidHardwareBufferPropertiesANDROID.html</a> </summary>
    ...
    ///     <item><term>errorcodes</term><description>VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_INVALID_EXTERNAL_HANDLE_KHR</description></item>
    /// </list></remarks>
    ...
    /// <summary> vkGetMemoryAndroidHardwareBufferANDROID - Get an Android hardware buffer for a memory object - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryAndroidHardwareBufferANDROID.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetMemoryAndroidHardwareBufferANDROID.html</a> </summary>
    ...
    public static void Load(VkDevice device) {
        ...
        {
            *pvkGetAndroidHardwareBufferPropertiesANDROID = (delegate*<VkDevice, AHardwareBuffer*, VkAndroidHardwareBufferPropertiesANDROID*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4174\u646e\u6f72\u6469\u6148\u6472\u6177\u6572\u7542\u6666\u7265\u7250\u706f\u7265\u6974\u7365\u4e41\u5244\u494f\u0044");
        }
        ...
        {
            *pvkGetMemoryAndroidHardwareBufferANDROID = (delegate*<VkDevice, VkMemoryGetAndroidHardwareBufferInfoANDROID*, AHardwareBuffer**, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(device, "\u6b76\u6547\u4d74\u6d65\u726f\u4179\u646e\u6f72\u6469\u6148\u6472\u6177\u6572\u7542\u6666\u7265\u4e41\u5244\u494f\u0044");
        }
    }
}
