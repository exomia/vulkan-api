...
/// <summary>
///     VK_KHR_android_surface - instance extension (nr. 9) - author 'KHR' [platform 'android' | contact 'Jesse Hall
///     @critsec']<br />
...
public static unsafe class VkKhrAndroidSurface
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_KHR_ANDROID_SURFACE_EXTENSION_NAME" /> represented by an
    ///     UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
    ...
    ///     <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateAndroidSurfaceKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateAndroidSurfaceKHR.html</a>
    /// </summary>
    /// <param name="instance">instance is the instance to associate the surface with.</param>
    /// <param name="pCreateInfo">
    ///     pCreateInfo is a pointer to a VkAndroidSurfaceCreateInfoKHRstructure containing parameters
