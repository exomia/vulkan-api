...
/// <summary>
///     VK_KHR_wayland_surface - instance extension (nr. 7) - author 'KHR' [platform 'wayland' | contact 'Jesse Hall
...
public static unsafe class VkKhrWaylandSurface
{
    ...
    /// <summary>
    ///     An UTF8 null terminated version of <see cref="VK_KHR_WAYLAND_SURFACE_EXTENSION_NAME" /> represented by an
    ///     UTF16 string.
    /// </summary>
    /// <remarks>
    ///     Example usage:<br />
    ...
    ///     <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateWaylandSurfaceKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateWaylandSurfaceKHR.html</a>
    /// </summary>
    /// <param name="instance">instance is the instance to associate the surface with.</param>
    /// <param name="pCreateInfo">
    ///     pCreateInfo is a pointer to a VkWaylandSurfaceCreateInfoKHRstructure containing parameters
    ...
    ///     <a
    ///         href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceWaylandPresentationSupportKHR.html">
