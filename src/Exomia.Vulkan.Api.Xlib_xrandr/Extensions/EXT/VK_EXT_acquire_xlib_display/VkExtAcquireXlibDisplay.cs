...
/// <summary>
///    VK_EXT_acquire_xlib_display - instance extension (nr. 90) - author 'NV' [platform 'xlib_xrandr' | contact 'James Jones @cubanismo']<br/>
...
public static unsafe partial class VkExtAcquireXlibDisplay
{
    ...
    ///     }
    /// </remarks>
    public const string VK_EXT_ACQUIRE_XLIB_DISPLAY_EXTENSION_NAME_UTF8_NT = "\u4b56\u455f\u5458\u415f\u5143\u4955\u4552\u585f\u494c\u5f42\u4944\u5053\u414c\u5f59\u5845\u4554\u534e\u4f49\u5f4e\u414e\u454d\u0000";

    /// <summary> vkAcquireXlibDisplayEXT - Acquire access to a VkDisplayKHR using Xlib - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkAcquireXlibDisplayEXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkAcquireXlibDisplayEXT.html</a> </summary>
    ...
    /// <summary> vkGetRandROutputDisplayEXT - Query the VkDisplayKHR corresponding to an X11 RandR Output - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetRandROutputDisplayEXT.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetRandROutputDisplayEXT.html</a> </summary>
    ...
    /// <remarks><list type="table">
    ///     <item><term>successcodes</term><description>VK_SUCCESS</description></item>
    ///     <item><term>errorcodes</term><description>VK_ERROR_OUT_OF_HOST_MEMORY</description></item>
    /// </list></remarks>
    public static readonly delegate*<
        VkPhysicalDevice /*physicalDevice*/, 
        Display* /*dpy*/, 
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkAcquireXlibDisplayEXT = (delegate*<VkPhysicalDevice, Display*, VkDisplayKHR, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u6341\u7571\u7269\u5865\u696c\u4462\u7369\u6c70\u7961\u5845\u0054");
        }
        ...
        {
            *pvkGetRandROutputDisplayEXT = (delegate*<VkPhysicalDevice, Display*, RROutput, VkDisplayKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u6547\u5274\u6e61\u5264\u754f\u7074\u7475\u6944\u7073\u616c\u4579\u5458\u0000");
        }
    }
}
