...
/// <summary>
///    VK_KHR_xcb_surface - instance extension (nr. 6) - author 'KHR' [platform 'xcb' | contact 'Jesse Hall @critsec,Ian Elliott @ianelliottus']<br/>
...
public static unsafe partial class VkKhrXcbSurface
{
    ...
    /// <summary> An UTF8 null terminated version of <see cref="VK_KHR_XCB_SURFACE_EXTENSION_NAME" /> represented by an UTF16 string. </summary>
    /// <remarks>
    ///     Example usage:<br/>
    ///     <br/>
    ...
    /// <summary> vkCreateXcbSurfaceKHR - Create a slink:VkSurfaceKHR object for a X11 window, using the XCB client-side library - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateXcbSurfaceKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkCreateXcbSurfaceKHR.html</a> </summary>
    /// <param name="instance">instance is the instance to associate the surface with.</param>
    /// <param name="pCreateInfo">pCreateInfo is a pointer to a VkXcbSurfaceCreateInfoKHRstructure containing parameters affecting the creation of the surface object.</param>
    ...
    /// <summary> vkGetPhysicalDeviceXcbPresentationSupportKHR - Query physical device for presentation to X11 server using XCB - <a href="https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceXcbPresentationSupportKHR.html">https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/vkGetPhysicalDeviceXcbPresentationSupportKHR.html</a> </summary>
    ...
    public static void Load(VkInstance instance) {
        ...
        {
            *pvkCreateXcbSurfaceKHR = (delegate*<VkInstance, VkXcbSurfaceCreateInfoKHR*, VkAllocationCallbacks*, VkSurfaceKHR*, VkResult>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u7243\u6165\u6574\u6358\u5362\u7275\u6166\u6563\u484b\u0052");
        }
        fixed(delegate*<VkPhysicalDevice, uint, xcb_connection_t*, xcb_visualid_t /*visual_id*/, VkBool32>* pvkGetPhysicalDeviceXcbPresentationSupportKHR = &vkGetPhysicalDeviceXcbPresentationSupportKHR) 
        {
            *pvkGetPhysicalDeviceXcbPresentationSupportKHR = (delegate*<VkPhysicalDevice, uint, xcb_connection_t*, xcb_visualid_t /*visual_id*/, VkBool32>)Exomia.Vulkan.Api.Core.Vk.GetVkFunction(instance, "\u6b76\u6547\u5074\u7968\u6973\u6163\u446c\u7665\u6369\u5865\u6263\u7250\u7365\u6e65\u6174\u6974\u6e6f\u7553\u7070\u726f\u4b74\u5248\u0000");
        }
    }
}
